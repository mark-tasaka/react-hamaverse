    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), only a single version of Steeler was released: the 1982 figure, with a 1983 swivel-arm variant. Steeler's file card lists his rank as O-1, a commissioned officer (Second Lieutenant) — yet his interactions with fellow enlisted team members throughout the comic depict him as one of the enlisted ranks himself.
          </p>
        </section>
