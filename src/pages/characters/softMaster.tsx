    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <p className="profile-intro">
          The Soft Master is an Arashikage ninja who takes a defensive, non-violent approach to combat. He is the younger brother of the <Link to="/character-bios/HardMaster">Hard Master</Link>, leader of the Arashikage clan, and Storm Shadow's uncle (Storm Shadow's deceased father was the Soft Master's younger brother). Sometime after the <Link to="/character-bios/HardMaster">Hard Master</Link>'s death, the Soft Master left Japan and moved to Spanish Harlem in New York, where he purchased a restaurant, Comidas Chinas.
        </p>
        ...
        <section className="profile-block">
          ...
          <p>
            When the <Link to="/character-bios/HardMaster">Hard Master</Link> was murdered, the Soft Master heard the commotion and dashed out of his room, only to see Storm Shadow fleeing with a bow in hand. Entering the dojo, he found the <Link to="/character-bios/HardMaster">Hard Master</Link> dying from an arrow wound. With his final breath, the <Link to="/character-bios/HardMaster">Hard Master</Link> insisted that Storm Shadow was not responsible for his death. Storm Shadow never returned. The Soft Master kept the arrow for years and eventually presents it to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> at his restaurant in Spanish Harlem (<Link to="/comic-issues/Issue26">Issue #26</Link>).
          </p>
        </section>
