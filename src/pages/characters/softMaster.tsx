    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Firefly">Firefly</Link>, Scrap-Iron, and Buzzer, riding a Ferret ATV, spot the Soft Master in the stolen car and give chase, firing a missile from the Ferret. The Soft Master avoids the missile by driving under a moving semi-truck, which shears off the top of his car in the process. He then drives across a set of train tracks, narrowly avoiding an oncoming train — which conveniently blocks the pursuing Ferret's path behind him.
          </p>
          <p>
