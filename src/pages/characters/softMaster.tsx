    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            When the Hard Master was murdered, the Soft Master heard the commotion and dashed out of his room, only to see Storm Shadow fleeing with a bow in hand. Entering the dojo, he found the Hard Master dying from an arrow wound. With his final breath, the Hard Master insisted that Storm Shadow was not responsible for his death. Storm Shadow never returned. The Soft Master kept the arrow for years and eventually presents it to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> at his restaurant in Spanish Harlem (<Link to="/comic-issues/Issue26">Issue #26</Link>).
          </p>
        </section>
