    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), three versions of Clutch were produced: the original 1982 version (with a 1983 swivel-arm variant), a 1984 repaint, and the 1993 version. Clutch was one of the original Joes who did not receive a pay-grade promotion from General Austin when others were assigned administrative duties to accommodate the team's growth. As a result, all three of Clutch's file cards show his rank as E-4.
          </p>
        </section>
