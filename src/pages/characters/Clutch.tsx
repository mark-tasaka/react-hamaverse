    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), three versions of Clutch were produced: the original <a href="https://www.yojoe.com/action/82/clutch.shtml" target="_blank" rel="noopener noreferrer">1982 version</a> (with a <a href="https://www.yojoe.com/action/83/clutch1p5.shtml" target="_blank" rel="noopener noreferrer">1983 swivel-arm</a> variant), a <a href="https://www.yojoe.com/action/84/clutch2.shtml" target="_blank" rel="noopener noreferrer">1984 repaint</a>, and the <a href="https://www.yojoe.com/action/93/clutch3.shtml" target="_blank" rel="noopener noreferrer">1993 version</a>. Clutch was one of the original Joes who did not receive a pay-grade promotion when <Link to="/character-bios/Austin">General Austin</Link> promoted eight others and assigned them administrative duties to accommodate the team's growth. As a result, all three of Clutch's file cards show his rank as E-4.
          </p>
