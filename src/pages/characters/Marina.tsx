    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Marina and a group of Lower Borovians are marched in front of the gulag the Hero (<Link to="/character-bios/SnakeEyes">Snake Eyes</Link>) has liberated. Beside him stands an American agent and friend (George Strawhacker) he rescued from the camp. Spotting the Hero, Marina points at him and shouts, "This man is no hero — he let the mob shoot my father!" Metz, the mob's leader, strikes Marina with his machine pistol, knocking her down, and levels the weapon at her. Just then, the Hero's friend, George Strawhacker, strikes Metz to the ground.  Metz raises his machine pistol and kills him.
          </p>
          <p>
            The shock of Strawhacker's death breaks the Arashikage Mindset's hold over the Hero, and he regains his humanity. He raises his gun at Metz, and the mob turns on their former leader, beating him and preparing to hang him. Marina pleads with the Hero to save Metz, telling him, "Even though he is a bad man, you cannot let them do this." Just as the noose tightens, the Hero shoots the rope, saving Metz's life, and departs with Marina at his side.
          </p>
          <p>
