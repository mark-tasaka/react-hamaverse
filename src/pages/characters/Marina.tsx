    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Marina and a group of Lower Borovians are marched in front of the gulag the Hero (<Link to="/character-bios/SnakeEyes">Snake Eyes</Link>) has liberated. Beside him stands an American agent and friend he rescued from the camp. Spotting the Hero, Marina points at him and shouts, "This man is no hero — he let the mob shoot my father!" Mertz, the mob's leader, strikes Marina with his machine pistol, knocking her down, and levels the weapon at her. Just then, the Hero's friend, George Strawhacker, strikes Mertz to the ground.  Mertz raises his machine pistol and kills him.
          </p>
          <p>
