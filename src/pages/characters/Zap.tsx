    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Zap, <Link to="/character-bios/Scarlett">Scarlett</Link>, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> are captured, gassed unconscious, and taken to the Cobra-occupied town of Springfield. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is subjected to Dr. Venom's Brainwave Scanner, while Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> are locked in a cell shared with <Link to="/character-bios/Billy">Billy</Link>, a captured anti-Cobra youth. When Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> wake up, they are still hallucinating from the drugs used on them.
          </p>
          <p>
            Later that day, Cobra guards slip cups of water and bread on a tray into the cell. Once the guards are gone, <Link to="/character-bios/Billy">Billy</Link> tells <Link to="/character-bios/Scarlett">Scarlett</Link> and Zap that the water is drugged, and demonstrates how to neutralize the drugs by placing the water near the light bulb. With the drugs neutralized, Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> drink the water and pretend to have passed out. <Link to="/character-bios/Billy">Billy</Link> then starts screaming about the anti-Cobra underground meeting happening that night. The guards hear this over the monitor and decide to take <Link to="/character-bios/Billy">Billy</Link> to Dr. Venom to learn more. Two guards enter the cell; Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> knock them out and take their uniforms.
          </p>
          <p>
            Dressed in Cobra uniforms, Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> escort <Link to="/character-bios/Billy">Billy</Link> past the guard in the control room. He tells them to bring <Link to="/character-bios/Billy">Billy</Link> to Dr. Venom for interrogation, reminding them to change into civilian clothes before reaching the surface. <Link to="/character-bios/Scarlett">Scarlett</Link> and Zap acquire civilian clothing and steal a car. Inside, <Link to="/character-bios/Billy">Billy</Link> tells them how the town became indoctrinated into Cobra — it started as a pyramid scheme selling household products door-to-door and morphed into indoctrination meetings.
          </p>
          <p>
            <Link to="/character-bios/Billy">Billy</Link> directs Zap and <Link to="/character-bios/Scarlett">Scarlett</Link> to Video World, where <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is being held in Dr. Venom's basement lab. They enter the arcade, which is filled with youths. <Link to="/character-bios/Billy">Billy</Link> points out that several of them are junior Cobra officers. The youths recognize <Link to="/character-bios/Billy">Billy</Link>, and they attack the trio (one of the video machines turns out to be a functional laser). <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> breaks free from Dr. Venom's lab and bursts through the door into the arcade. The three Joes and <Link to="/character-bios/Billy">Billy</Link> flee, escaping in the stolen car outside.
          </p>
          <p>
