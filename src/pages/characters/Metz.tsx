    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <p className="profile-intro">
          The leader of the revolutionary force when the communist government of Borovia is overthrown, Metz calls for the ethnic cleansing of the Lower Borovians, using <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' exploits to rally the mob to his will. Metz is later betrayed by the mercenary Major Bludd and is nearly hanged before <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> saves his life. A new president of Borovia is elected, but Metz's political ambitions continue — and when the new government falls, he forms an alliance with Cobra Commander, becoming president himself.
        </p>
