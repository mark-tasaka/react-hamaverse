    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Lady Jaye's first encounter with <Link to="/character-bios/Scarlett">Scarlett</Link> is far from a warm one — the two don't hit it off. <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/Grunt">Grunt</Link> are working on machinery when Lady Jaye and <Link to="/character-bios/RipCord">Rip Cord</Link> walk into the Pit. <Link to="/character-bios/Grunt">Grunt</Link> assumes the two are unauthorized personnel who have wandered into by mistake. <Link to="/character-bios/Scarlett">Scarlett</Link> warns them they have entered a restricted installation and asks for ID. Lady Jaye refuses to show it, meeting <Link to="/character-bios/Scarlett">Scarlett</Link>'s question with attitude.
          </p>
          <p>
            <Link to="/character-bios/RipCord">Rip Cord</Link>, playing the diplomat, tells <Link to="/character-bios/Scarlett">Scarlett</Link> that Lady Jaye didn't mean anything by it. Lady Jaye, unmoved, refers to <Link to="/character-bios/Scarlett">Scarlett</Link> as a "tawdry redhead" and says plainly that she doesn't care for her attitude.
          </p>
          <p>
            <Link to="/character-bios/RipCord">Rip Cord</Link> diplomatically opens the envelope containing their orders and hands them to <Link to="/character-bios/Grunt">Grunt</Link>, explaining that the papers confirm their permanent assignment to the G.I. Joe team. Lady Jaye adds, with a sharp look at <Link to="/character-bios/Scarlett">Scarlett</Link>, "We are here as your replacements" (Issue #32).
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Chief Warrant Officer Dashiell Faireborn (<Link to="/character-bios/Flint">Flint</Link>) shows interest in Lady Jaye when he joins the team. She finds him arrogant and pompous at first. One day, the two are talking among the trees outside Fort Wadsworth. <Link to="/character-bios/Flint">Flint</Link> tells her he's a man of many assets — good-looking, dashing, and intelligent. Lady Jaye pushes back on his lack of modesty, remarking that at least his insurance policy is paid up. <Link to="/character-bios/Flint">Flint</Link> tells her he carries the standard policy from Uncle Sugar, and asks if she'd be interested in becoming his beneficiary.
          </p>
          <p>
            Lady Jaye spots Cobra Eels emerging from the water of the Narrows and pulls <Link to="/character-bios/Flint">Flint</Link> down to the ground with her. <Link to="/character-bios/Flint">Flint</Link> assumes she's suddenly taken an interest in him. She tells him to put a lid on it, and points to the approaching Eels.
          </p>
          <p>
            <Link to="/character-bios/Flint">Flint</Link> tells Lady Jaye to warn the others while he distracts the Eels, then launches himself at them unarmed. Lady Jaye runs to alert the Joes of the incoming attack. Later, <Link to="/character-bios/Flint">Flint</Link> meets up with her and the rest of the team at the armory — badly beaten and bruised, but alive. Impressed by his courage and reckless disregard for his own safety, Lady Jaye begins to take a liking to <Link to="/character-bios/Flint">Flint</Link> (Issue #53).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Lady Jaye, <Link to="/character-bios/Flint">Flint</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> are on vacation in Grenada. At the beach, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> spends his time watching a portable TV, following news of the arrest and trial of the three captured Joes. <Link to="/character-bios/Flint">Flint</Link> lectures him that orders are orders and there will be no rescue mission — the three Joes are grown men who knew what they were getting into. <Link to="/character-bios/Scarlett">Scarlett</Link> tells <Link to="/character-bios/Flint">Flint</Link> that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Stalker">Stalker</Link> go way back, and that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> needs time to sort this out for himself.
          </p>
          <p>
            Later, the two couples are walking back to their hotel along a dirt road when they encounter an older blind man. He tells them he's on his way to visit his daughter and asks for help reaching the airport before he's late. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> quickly offers his arm.  The blind man insists on taking a shortcut through a field of tall grass. <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> guide him through the field, while Lady Jaye and <Link to="/character-bios/Flint">Flint</Link> continue on down the road.
          </p>
          <p>
            It suddenly dawns on <Link to="/character-bios/Flint">Flint</Link> that he's seen this field somewhere before — then he remembers it from a news report about a military operation. Just then, he spots a broken sign buried in the tall grass and clears away the growth to reveal the words "Danger: Mines." <Link to="/character-bios/Flint">Flint</Link> shouts, "Snake Eyes! Scarlett! Stop! That field is mined!" — just as a powerful explosion goes off. Lady Jaye starts to run toward the blast, but <Link to="/character-bios/Flint">Flint</Link> tackles her to the ground, telling her they have no way of knowing how many more mines lie in that field.
          </p>
          <p>
