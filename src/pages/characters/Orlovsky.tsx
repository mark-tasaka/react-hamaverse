    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            After hearing the sadistic Comrade Sgt. Mosiev mock the <Link to="/character-bios/WhiteClown">White Clown</Link> over his beloved Magda's fate, Orlovsky steps in. He tells the Sergeant he knows what happened to her — whether she's alive or not — and asks what harm there could be in simply telling the <Link to="/character-bios/WhiteClown">White Clown</Link> either way. Sgt. Mosiev strikes Orlovsky, telling him the information is a state secret.
          </p>
          <p>
