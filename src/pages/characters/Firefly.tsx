    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/CobraCommander">Cobra Commander</Link> pays Firefly to engineer the assassination of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, whom he blames for his brother Dan's fatal car accident. As a ninja master, Firefly gains access to <Link to="/character-bios/Onihashi">Professor Onihashi</Link>'s shop, and through that association, gains access to the Arashikage household itself — training at the family dojo and studying its secret forms under the adopted name the Faceless One.
          </p>
          <p>
            Witnessing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' skill firsthand, Firefly realizes he's no match for him, and instead recommends an outside contractor to assissinate <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>.  This outside contractor <Link to="/character-bios/CobraCommander">Cobra Commander</Link> recruits is <Link to="/character-bios/Zartan">Zartan</Link>. Firefly supplies <Link to="/character-bios/Zartan">Zartan</Link> with the sound-amplifying compound bow that kills the <Link to="/character-bios/HardMaster">Hard Master</Link>, and later pilots the helicopter that carries <Link to="/character-bios/Zartan">Zartan</Link> away (Issue #126).
          </p>
          <p className="italics">
