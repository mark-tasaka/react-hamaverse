    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Firefly's father was a plantation owner and anti-Japanese guerrilla in French Indochina during the 1940s. He once spared the life of a young Japanese officer — the son of the Grand Master of the Koga ninja clan. After the Viet Minh betrayed and murdered his father, the Koga clan took Firefly in and trained him, and he became the first outsider ever to master any style of ninjutsu.
          </p>
          <p>
            The man who would become Cobra Commander pays Firefly to engineer the assassination of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, whom he blames for his brother Dan's fatal car accident. As a ninja master, Firefly gains access to <Link to="/character-bios/Onihashi">Professor Onihashi</Link>'s shop, and through that association, works his way into the Arashikage household itself — training at the family dojo and studying its secret forms under the adopted name the Faceless One.
          </p>
          <p>
            Witnessing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' skill firsthand, Firefly realizes he's no match for him, and instead recommends Zartan to Cobra Commander for the assassination. Firefly supplies Zartan with the sound-amplifying compound bow used to kill the <Link to="/character-bios/HardMaster">Hard Master</Link>, and later pilots the helicopter that carries Zartan to safety (Issue #126).
          </p>
          <p>
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), two unique molds of the Firefly action figure were produced: the 1984 version and the 1992 version (with a 1993 repaint). Firefly is best known for his 1984 figure, featuring an urban gray-and-black camouflage pattern. A green-toned version of his uniform appeared from Issue #126 through the end of the Marvel run; afterward, Firefly returns to his classic black-and-gray urban camo.
          </p>
        </section>
