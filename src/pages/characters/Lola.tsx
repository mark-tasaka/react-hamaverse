    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Lola and Bob (<Link to="/character-bios/Grunt">Grunt</Link>) meet Roadblock at Dr. Burkhart's home. <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> picks up <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> at the airport. <Link to="/character-bios/Jinx">Jinx</Link>, having accessed the Defense Language Institute's computer system in San Francisco, knows that Generals <Link to="/character-bios/Hawk">Hawk</Link> and Hollingsworth are being held in a hospital in rural Virginia. Soon after, a truck arrives carrying more Joes: <Link to="/character-bios/CoverGirl">Cover Girl</Link>, Dusty, Bazooka, Barbecue, <Link to="/character-bios/Flash">Flash</Link>, Wet-Suit, Snow Job, <Link to="/character-bios/Steeler">Steeler</Link>, and <Link to="/character-bios/Zap">Zap</Link>.
          </p>
          <p>
