    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes travels to Japan to take Tommy up on his offer to join the family business — which turns out to be the Arashikage ninja clan. Over the next three years, Snake Eyes trains with the clan and attains a level of skill that earns him the Arashikage tattoo on his forearm. He also gains favored status in the eyes of the <Link to="/character-bios/HardMaster">Hard Master</Link>, the clan's leader, who intends to name Snake Eyes his heir over his own nephew, Thomas Arashikage (Storm Shadow).
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            During Snake Eyes' visit with the Soft Master at the Comidas Chinas café in New York City (which the Soft Master owns), Storm Shadow steals the arrow that had killed the <Link to="/character-bios/HardMaster">Hard Master</Link> — an arrow the Soft Master had kept over the years. Snake Eyes pursues Storm Shadow to the top of a moving train, and the two battle. With his back turned away from the direction the train is traveling, Storm Shadow fails to notice an upcoming tunnel. Snake Eyes drops his weapon and leaps down between the train cars, prompting Storm Shadow to follow — an action that ends up saving Storm Shadow's life.
          </p>
          <p>
            Between the cars, Storm Shadow drops his weapon and tells Snake Eyes he did not kill his uncle, the <Link to="/character-bios/HardMaster">Hard Master</Link>. Earlier that day, he explains, he shot a squirrel with his bow, but when he went to retrieve the arrow, both the squirrel and the arrow were gone. Storm Shadow says he saw the real assassin — the one who shot the <Link to="/character-bios/HardMaster">Hard Master</Link> with that same arrow — escape aboard a Cobra helicopter, and that he joined Cobra's ranks to track down his uncle's killer. Storm Shadow then departs (<Link to="/comic-issues/Issue27">Issue #27</Link>).
          </p>
        </section>
