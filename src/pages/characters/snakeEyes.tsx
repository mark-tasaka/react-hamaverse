    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, Flint, and <Link to="/character-bios/LadyJay">Lady Jaye</Link> are vacationing in Grenada when they encounter a blind man walking down the road. The blind man asks for help reaching the airfield in time to meet his daughter, and Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link> agree to guide him through a shortcut across a field of tall grass, while <Link to="/character-bios/LadyJay">Lady Jaye</Link> and Flint remain on the road.
          </p>
          <p>
