    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link> travel to the Bern Institute of Reconstructive Surgery in Switzerland, where Snake Eyes is to undergo surgery to restore his face. <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>, who had reconstructed the Baroness' face years earlier, contacts her about the situation. The Baroness, who falsely believes Snake Eyes killed her brother in Saigon during the Tet Offensive, makes plans to capture Snake Eyes while he is under the knife (<Link to="/comic-issues/Issue93">Issue #93</Link>).
          </p>
          <p>
            At the hospital, <Link to="/character-bios/Scarlett">Scarlett</Link> receives a call from <Link to="/character-bios/Hawk">Hawk</Link>, who has just learned of the plot between the Baroness and <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>. <Link to="/character-bios/Scarlett">Scarlett</Link> breaks into the operating room, ties up <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> and his assistants, places the unconscious Snake Eyes in a wheelchair, and makes her way out of the surgery room. Just then, the Baroness arrives with a group of Vipers.
          </p>
          <p>
