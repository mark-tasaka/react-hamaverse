    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> first travel to France (Issue #64), then on to Borovia, where they join a circus troupe (Issue #65). The troupe is led by the <Link to="/character-bios/WhiteClown">White Clown</Link>, whose lover, Magda, is locked away in a Borovian gulag for criticizing the government. Assisting the <Link to="/character-bios/WhiteClown">White Clown</Link> is the dwarf Orlovsky.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> later arrive and join up with Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link>. Together, the six raid the gulag, kill the guards, and free all the prisoners, including <Link to="/character-bios/Stalker">Stalker</Link>, Quick Kick, and Snow Job. As the Joes approach the river bordering Borovia, they encounter the <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky, who have the circus cannon hauled behind his car. The <Link to="/character-bios/WhiteClown">White Clown</Link> fires the Joes from the cannon, launching them safely into the river, where they swim to the other side (Issue #66).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes then makes his way to the headquarters of the Security Police, a building surrounded by crowds of Upper Borovians seeking to overthrow the government — among them the <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky the dwarf. Snake Eyes rushes the building, leaping through a hail of gunfire. The <Link to="/character-bios/WhiteClown">White Clown</Link> recognizes Snake Eyes by his acrobatic style, and he and Orlovsky follow him inside. Shortly after, the crowd surges forward and storms the building.
          </p>
          <p>
          ...
          <p>
            As Snake Eyes leaves the building, a young girl named <Link to="/character-bios/Marina">Marina</Link> runs up to him, pleading that the mob is about to execute her father for being an Upper Borovian. Snake Eyes ignores her pleas, and the mob shoots her father in the street. The <Link to="/character-bios/WhiteClown">White Clown</Link> notices how much Snake Eyes has changed. He and Orlovsky then drive Snake Eyes to Gulag 23 (Issue #104).
          </p>
          <p>
            Outside Gulag 23, a mob has gathered, made up of people whose family members are imprisoned inside. Snake Eyes storms the gulag, killing the guards on the surface before descending into the sewers. The <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky soon follow.
          </p>
          <p>
