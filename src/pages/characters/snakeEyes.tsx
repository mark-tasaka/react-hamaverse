    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> first travel to France (Issue #64), then on to Borovia, where they join a circus troupe (Issue #65). The troupe is led by the <Link to="/character-bios/WhiteClown">White Clown</Link>, whose lover, Magda, is locked away in a Borovian gulag for criticizing the government. Assisting the <Link to="/character-bios/WhiteClown">White Clown</Link> is the dwarf <Link to="/character-bios/Orlovsky">Orlovsky</Link>.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Inside, Snake Eyes searches the records room until he finds Strawhacker's file. Looking over his shoulder, the <Link to="/character-bios/WhiteClown">White Clown</Link> sees that Strawhacker is being held in a secret security block beneath Gulag 23 — the same place where his beloved Magda is imprisoned.
          </p>
          <p>
