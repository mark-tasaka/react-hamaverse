    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            A few months after Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link>'s first encounter, Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/Grunt">Grunt</Link>, and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> are on a hostage rescue mission in the Middle East. Lacking proper dust filters, the helicopter's engine stalls, and the pilot gives the order to jump. <Link to="/character-bios/Grunt">Grunt</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> jump clear, but one of the helicopter's doors slams shut, trapping <Link to="/character-bios/Scarlett">Scarlett</Link>'s web gear inside. Snake Eyes refuses to jump and instead stays behind to save her.
          </p>
          <p>
            The helicopter crashes into a second helicopter, and the impact sends burning aviation fuel spewing through the plexiglass door window, burning Snake Eyes' face and severing his vocal cords. <Link to="/character-bios/Scarlett">Scarlett</Link> is knocked unconscious in the crash. <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> and <Link to="/character-bios/Grunt">Grunt</Link> run to the burning wreckage and find a horribly burned Snake Eyes carrying an unconscious <Link to="/character-bios/Scarlett">Scarlett</Link> to safety.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and <Link to="/character-bios/Zap">Zap</Link> are captured while investigating a suspected Cobra stronghold in Manhattan. Knocked unconscious with sleeping gas, they awaken in the Cobra town of Springfield. <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/Zap">Zap</Link> wake up in a prison cell, while Snake Eyes wakes up in <Link to="/character-bios/Venom">Dr. Venom</Link>'s laboratory, hooked up to the Brainwave Scanner.
          </p>
          <p>
            <Link to="/character-bios/Venom">Dr. Venom</Link> uses the scanner to learn the location of the G.I. Joe secret base, and in the process, it collects and stores Snake Eyes' memories (memories that Dr. Mindbender will later use to create his Snake Eyes clone). Snake Eyes draws on his ninja training to slow his heartbeat and breathing to the semblance of death. Believing him dead, <Link to="/character-bios/Venom">Dr. Venom</Link> and his assistant unhook Snake Eyes from the scanner — at which point Snake Eyes attacks, knocking both out.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/Flint">Flint</Link>, and <Link to="/character-bios/LadyJay">Lady Jaye</Link> are vacationing in Grenada when they encounter a blind man walking down the road. The blind man asks for help reaching the airfield in time to meet his daughter, and Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link> agree to guide him through a shortcut across a field of tall grass, while <Link to="/character-bios/LadyJay">Lady Jaye</Link> and <Link to="/character-bios/Flint">Flint</Link> remain on the road.
          </p>
          <p>
            <Link to="/character-bios/Flint">Flint</Link> finds himself wondering where he has seen that field before — then realizes he has seen news articles identifying it as a minefield. Just after uncovering a "Danger: Mines" sign buried in the grass, an explosion goes off. It appears that Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the blind man have been killed in the blast. The blind man, however, turns out to be the <Link to="/character-bios/BlindMaster">Blind Master</Link>, who has helped Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link> fake their deaths so they can travel to Borovia to rescue <Link to="/character-bios/Stalker">Stalker</Link>, Quick Kick, and Snow Job (Issue #63).
          </p>
          <p>
            Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> first travel to France (Issue #64), then on to Borovia, where they join a circus troupe (Issue #65). The troupe is led by the <Link to="/character-bios/WhiteClown">White Clown</Link>, whose lover, <Link to="/character-bios/Magda">Madga</Link>, is locked away in a Borovian gulag for criticizing the government. Assisting the <Link to="/character-bios/WhiteClown">White Clown</Link> is the dwarf <Link to="/character-bios/Orlovsky">Orlovsky</Link>.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> later arrive and join up with Snake Eyes, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link>. Together, the six raid the gulag, kill the guards, and free all the prisoners, including <Link to="/character-bios/Stalker">Stalker</Link>, Quick Kick, and Snow Job. As the Joes approach the river bordering Borovia, they encounter the <Link to="/character-bios/WhiteClown">White Clown</Link> and <Link to="/character-bios/Orlovsky">Orlovsky</Link>, who have the circus cannon hauled behind his car. The <Link to="/character-bios/WhiteClown">White Clown</Link> fires the Joes from the cannon, launching them safely into the river, where they swim to the other side (Issue #66).
          </p>
        </section>

        <section className="profile-block">
          <h2 className="profile-block-title">Reconstructive Surgery and the Baroness' Revenge</h2>
          <img src={snakeEyes14} alt="Snake Eyes and theBaroness' revenge plot" className="profile-block-img" />
          <p>
            Snake Eyes and <Link to="/character-bios/Scarlett">Scarlett</Link> travel to the Bern Institute of Reconstructive Surgery in Switzerland, where Snake Eyes is to undergo surgery to restore his face. <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>, who had reconstructed the <Link to="/character-bios/Baroness">Baroness</Link>' face years earlier, contacts her about the situation. The <Link to="/character-bios/Baroness">Baroness</Link>, who falsely believes Snake Eyes killed her brother in Saigon during the Tet Offensive, makes plans to capture Snake Eyes while he is under the knife (<Link to="/comic-issues/Issue93">Issue #93</Link>).
          </p>
          <p>
            At the hospital, <Link to="/character-bios/Scarlett">Scarlett</Link> receives a call from <Link to="/character-bios/Hawk">Hawk</Link>, who has just learned of the plot between the <Link to="/character-bios/Baroness">Baroness</Link> and <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>. <Link to="/character-bios/Scarlett">Scarlett</Link> breaks into the operating room, ties up <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> and his assistants, places the unconscious Snake Eyes in a wheelchair, and makes her way out of the surgery room. Just then, the <Link to="/character-bios/Baroness">Baroness</Link> arrives with a group of Vipers.
          </p>
          <p>
            One of the Vipers shoots <Link to="/character-bios/Scarlett">Scarlett</Link> in the arm. The <Link to="/character-bios/Baroness">Baroness</Link> then stands over the wounded <Link to="/character-bios/Scarlett">Scarlett</Link> and shoots her point-blank in the head before taking the unconscious Snake Eyes to the Cobra Consulate in New York (<Link to="/comic-issues/Issue94">Issue #94</Link>).
          </p>
          <p>
            Snake Eyes is taken to the Consulate's subbasement, where he is met by the Paine Brothers, a trio of torturers, and chained to the wall. The <Link to="/character-bios/Baroness">Baroness</Link> tells the now conscious Snake Eyes she has killed his beloved <Link to="/character-bios/Scarlett">Scarlett</Link> and will have him tortured to death for the murder of her brother. Just then, a Tele-Viper informs her that Destro will be arriving by helicopter on the Consulate's roof, and she departs to meet him.
          </p>
          <p>
          ...
          <p>
            Snake Eyes then makes his way up to the second sublevel and fills a duffle bag with explosives. He strategically plants them throughout the lower levels, triggering explosions that render the level below him impassable. Most of the Consulate's occupants flee, save for a mixed platoon of Vipers and the <Link to="/character-bios/Baroness">Baroness</Link> herself. Snake Eyes then proceeds upward to confront them (<Link to="/comic-issues/Issue95">Issue #95</Link>).
          </p>
          <p>
            Outside the Consulate, at a newsstand, <Link to="/character-bios/Stalker">Stalker</Link>, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Wade">Wade Collins</Link> keep watch. <Link to="/character-bios/StormShadow">Storm Shadow</Link> uses his ninja abilities to scale the Consulate's walls to reach Snake Eyes. Meanwhile, the <Link to="/character-bios/Baroness">Baroness</Link> and the surviving Vipers barricade themselves in the penthouse. Snake Eyes, disguised as one of the Vipers, waits inside as <Link to="/character-bios/StormShadow">Storm Shadow</Link> approaches from the other side of the penthouse door. A Heat Viper fires a missile that blows the barricade open; <Link to="/character-bios/StormShadow">Storm Shadow</Link> dodges the blast and enters, searching for Snake Eyes. Snake Eyes then reveals himself, and the sword brothers square off as the penthouse begins to collapse around them.
          </p>
          <p>
            The Vipers are thrown to their deaths as the floor gives way. The <Link to="/character-bios/Baroness">Baroness</Link> is about to fall as well, when Snake Eyes catches her hand. Shocked that he would save her, she draws her pistol with her free hand and points it at him, vowing she will still have her revenge. At that moment, Destro arrives in the crew compartment of a Cobra helicopter.
          </p>
          <p>
            Destro tells the <Link to="/character-bios/Baroness">Baroness</Link> that Snake Eyes did not kill her brother. He reveals that he was in Saigon with his father, the previous Destro, investigating the murder, and explains that Eugen DeCobray was wearing a bulletproof vest — it was the AK-47 rounds themselves that killed him.
          </p>
          <p>
            Overcome with guilt, the <Link to="/character-bios/Baroness">Baroness</Link> strikes Snake Eyes' hand, breaking his grip on her. <Link to="/character-bios/StormShadow">Storm Shadow</Link> catches her before she can fall to her death, and together, he and Snake Eyes help her toward Destro's helicopter. As Destro reaches out for Snake Eyes, the floor beneath Snake Eyes and <Link to="/character-bios/StormShadow">Storm Shadow</Link> gives way.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Snake Eyes then makes his way to the headquarters of the Security Police, a building surrounded by crowds of Upper Borovians seeking to overthrow the government — among them the <Link to="/character-bios/WhiteClown">White Clown</Link> and <Link to="/character-bios/Orlovsky">Orlovsky</Link> the dwarf. Snake Eyes rushes the building, leaping through a hail of gunfire. The <Link to="/character-bios/WhiteClown">White Clown</Link> recognizes Snake Eyes by his acrobatic style, and he and <Link to="/character-bios/Orlovsky">Orlovsky</Link> follow him inside. Shortly after, the crowd surges forward and storms the building.
          </p>
          <p>
            Inside, Snake Eyes searches the records room until he finds Strawhacker's file. Looking over his shoulder, the <Link to="/character-bios/WhiteClown">White Clown</Link> sees that Strawhacker is being held in a secret security block beneath Gulag 23 — the same place where his beloved <Link to="/character-bios/Magda">Madga</Link> is imprisoned.
          </p>
          <p>
            As Snake Eyes leaves the building, a young girl named <Link to="/character-bios/Marina">Marina</Link> runs up to him, pleading that the mob is about to execute her father for being an Upper Borovian. Snake Eyes ignores her pleas, and the mob shoots her father in the street. The <Link to="/character-bios/WhiteClown">White Clown</Link> notices how much Snake Eyes has changed. He and <Link to="/character-bios/Orlovsky">Orlovsky</Link> then drive Snake Eyes to Gulag 23 (Issue #104).
          </p>
          <p>
            Outside Gulag 23, a mob has gathered, made up of people whose family members are imprisoned inside. Snake Eyes storms the gulag, killing the guards on the surface before descending into the sewers. The <Link to="/character-bios/WhiteClown">White Clown</Link> and <Link to="/character-bios/Orlovsky">Orlovsky</Link> soon follow.
          </p>
          <p>
            In the sewers, Snake Eyes comes across a group of guards fleeing with Strawhacker and <Link to="/character-bios/Magda">Madga</Link>. He dispatches the guards and frees the two prisoners. Strawhacker recognizes Snake Eyes despite his mask, and the <Link to="/character-bios/WhiteClown">White Clown</Link> embraces <Link to="/character-bios/Magda">Madga</Link>.
          </p>
          <p>
            When they return to the surface and rejoin the mob surrounding the gulag, <Link to="/character-bios/Magda">Madga</Link> is horrified to see that the revolution has given rise to ethnic cleansing. <Link to="/character-bios/Marina">Marina</Link> and several other Upper Borovians are being led into the crowd to be killed. <Link to="/character-bios/Marina">Marina</Link> spots Snake Eyes and tells the crowd he is no hero — he let her father be executed. The mob's leader, <Link to="/character-bios/Metz">Metz</Link>, pistol-whips <Link to="/character-bios/Marina">Marina</Link> and points his gun at her, calling her subhuman.
          </p>
          <p>
            Strawhacker strikes <Link to="/character-bios/Metz">Metz</Link>, knocking him to the ground, and tells him he is no different from the regime they just overthrew. <Link to="/character-bios/Metz">Metz</Link> shoots and kills Strawhacker — and the shock of it breaks the Arashikage Mindset's hold over Snake Eyes. Snake Eyes raises his gun toward <Link to="/character-bios/Metz">Metz</Link>. The mob sides with Snake Eyes and beats <Link to="/character-bios/Metz">Metz</Link>.
          </p>
          <p>
            As the mob prepares to hang <Link to="/character-bios/Metz">Metz</Link>, <Link to="/character-bios/Marina">Marina</Link> begs Snake Eyes to save him, insisting that even if <Link to="/character-bios/Metz">Metz</Link> is a bad man, they can't let him be hanged. Just as the noose tightens, Snake Eyes shoots the rope, saving <Link to="/character-bios/Metz">Metz</Link>'s life. Snake Eyes then departs Borovia together with <Link to="/character-bios/Marina">Marina</Link> (Issue #106). In America, <Link to="/character-bios/Marina">Marina</Link> is adopted by the Collins family, becoming Sean and Heather's sister (Issue #108).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            As Cobra Island comes under attack and faces an existential threat, Dr. Mindbender initiates one of his backup plans. He and a Techno-Viper travel to the morgue where a cloned body of Snake Eyes is kept. Years earlier, using Snake Eyes' memories and DNA obtained by <Link to="/character-bios/Venom">Dr. Venom</Link> from the Brainwave Scanner, Dr. Mindbender had created a duplicate of Snake Eyes free of the injuries the original sustained, including those to his vocal cords. Dr. Mindbender's goal is to create a clone of Snake Eyes fully loyal to Cobra.
          </p>
          <p>
