    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            On Firefly's recommendation, the man who would become Cobra Commander hires Zartan to assassinate <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, who is living with the Arashikage clan in Japan. Knowing he must infiltrate the clan through the tradesman's door, Zartan spends the next six months — sunrise to sunset — sitting outside the garden gates of <Link to="/character-bios/Onihashi">Professor Onihashi</Link>'s residence, the Arashikage clan's official armorer. He is eventually granted an interview. Impressed by his determination, <Link to="/character-bios/Onihashi">Onihashi</Link> tells Zartan that most applicants give up after the first two months — then adds that he sees the true nature of Zartan's heart, that he is a liar with bad karma running through his veins. Despite this, <Link to="/character-bios/Onihashi">Onihashi</Link> says he will attempt to temper Zartan's sword in his humble furnace, hammering out the impurities of his soul.
          </p>
          <p>
            At first light, Zartan and <Link to="/character-bios/Onihashi">Onihashi</Link> set out on the twenty-mile journey by foot to the professor's secret mountain forge (Issue #84). There, they forge Evening Star, a duplicate of the legendary blade Morning Light (Storm Shadow #4). Through the purification rituals and the painstaking process of folding layers of steel, Zartan finds a peace he has always sought. He no longer wants to carry out his mission of killing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> — all he wants is to continue his work at the forge. When the blade is complete, <Link to="/character-bios/Onihashi">Professor Onihashi</Link> presents it to the <Link to="/character-bios/HardMaster">Hard Master</Link>.
          </p>
          <p>
            Sensing this newfound peace and Zartan's reluctance to finish the job, Cobra Commander confronts him, threatening to expose him to his mentor if he doesn't fulfill the contract. Firefly supplies Zartan with a compound bow fitted with sound-amplification and directional-ranging equipment. Zartan steals one of <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s arrows from outside the courtyard wall — <Link to="/character-bios/StormShadow">Storm Shadow</Link> had used it earlier to kill a squirrel on the other side. Hiding in the courtyard, Zartan targets the dojo where <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is training with the <Link to="/character-bios/HardMaster">Hard Master</Link>, who is demonstrating the technique of "Donning the Cloak of the Chameleon," mimicking <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' heartbeat and breathing. Zartan kills the <Link to="/character-bios/HardMaster">Hard Master</Link> by mistake.
          </p>
          <p>
            Zartan flees with <Link to="/character-bios/StormShadow">Storm Shadow</Link> in pursuit. Waiting for him outside the courtyard is a Cobra helicopter piloted by Firefly; Zartan climbs aboard and escapes.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Zartan — disguised as the <Link to="/character-bios/BlindMaster">Blind Master</Link> — and <Link to="/character-bios/Tyrone">Tyrone</Link> drive to the woods outside Denver, in front of the Rockies, where they find <Link to="/character-bios/Billy">Billy</Link> and Raptor preparing to exhume Cobra Commander's body. Disgusted, Zartan strikes Raptor and tells <Link to="/character-bios/Billy">Billy</Link> not to let this trash desecrate his father's grave, warning him about the endless cycle of vengeance. <Link to="/character-bios/Billy">Billy</Link> convinces him that the true target of their revenge is the current Cobra Commander (Issue #95).
          </p>
          <p>
            The four travel to the Gulf of Mexico, where they hire Captain Minh to take them to Cobra Island. On the beaches of Cobra Island, using binoculars, <Link to="/character-bios/Billy">Billy</Link> notices that the body language of the person wearing the Cobra Commander armor doesn't match his father's. Raptor reveals that the man in the armor is Fred VII, the Crimson Guardsman who built <Link to="/character-bios/Billy">Billy</Link>'s prosthetic leg.
          </p>
          <p>
            Captain Minh comments that the device concealing his boat looks like something Zartan would make. Zartan simply replies that "Zartan is no more," then leaves the group to scout ahead.  He enters the landlocked freighter where a dinner party for potential weapons buyers is underway. Raptor departs sometime afterward, pursuing an agenda of his own.
          </p>
          <p>
            Aboard the freighter, Zartan transforms into Dr. Mindbender and arranges a private meeting with Fred VII. There, he reveals himself, holds a gun to Fred VII's head, and orders him back to his old life as a garage owner in Denver — all while the real Dr. Mindbender watches the exchange from behind an ajar door.
          </p>
          <p>
            Shortly after, Raptor confronts Dr. Mindbender privately, describing his trouble controlling the imposter Cobra Commander, and reveals he knows where the real Cobra Commander is buried — remains Dr. Mindbender could use to clone a more controllable "competitor." Raptor, Dr. Mindbender, and a team of Vipers depart to exhume the body (Issue #97).
          </p>
          <p>
            The next day, Croc Master brings his captives — <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and Captain Minh — aboard the freighter, where Fred VII, Firefly, Voltar, and Zartan are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing Fred VII of being an imposter responsible for murdering his father, the real Cobra Commander. Voltar demands proof, suggesting perhaps <Link to="/character-bios/Billy">Billy</Link> is the imposter. Mid-argument, the lights go out, and the top hatch opens to reveal the real Cobra Commander and his Crimson Guard, alongside Dr. Mindbender, Raptor, and the Viper excavation team. The real Cobra Commander throws Dr. Mindbender, Raptor, and the excavation team down into the freighter and seals the hatch.
          </p>
          <p>
            Soon after, a series of explosions diverts a water channel, carrying the freighter into an inactive volcano; further explosions bury it deep within, trapping everyone inside (Issue #98). In time, <Link to="/character-bios/Billy">Billy</Link> and Zartan escape; the others die of botulism from tainted rations aboard the freighter (Issue #116). Later issues reveal that Firefly also escaped.
          </p>
        </section>

        <section className="profile-block">
          <h2 className="profile-block-title">Acquiring Evening Star</h2>
          <img src={zartan5} alt="Zartan acquiring Evening Star" className="profile-block-img" />
          <p>
            <Link to="/character-bios/PalePeony">Pale Peony</Link> is hired to acquire Morning Light, the legendary Arashikage sword believed to be in <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s possession. She travels to his secret water tower base and draws the sword kept there, only to find the blade broken. <Link to="/character-bios/StormShadow">Storm Shadow</Link> is waiting for her inside, and the two duel. Zartan — disguised as FSB Captain Bulgokov — and <Link to="/character-bios/PalePeony">Pale Peony</Link>'s nephew arrive on the rooftop where the water tower stands. In the midst of the duel, Zartan reveals his true form and fires arrows at <Link to="/character-bios/StormShadow">Storm Shadow</Link>, who cuts them down in flight. Zartan retrieves the broken arrows, examines them, and reveals that the blade <Link to="/character-bios/StormShadow">Storm Shadow</Link> carries is Evening Star — the duplicate he and <Link to="/character-bios/Onihashi">Professor Onihashi</Link> forged decades earlier.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link> reveals that Morning Light is on display in a museum, then presents Evening Star to Zartan, telling him it belongs with <Link to="/character-bios/Onihashi">Professor Onihashi</Link>'s last apprentice. With her objective out of reach, <Link to="/character-bios/PalePeony">Pale Peony</Link> disarms her nephew, stopping him from firing on <Link to="/character-bios/StormShadow">Storm Shadow</Link>. <Link to="/character-bios/StormShadow">Storm Shadow</Link> then offers to buy the two noodles in the East Village, and the three depart in haste as police close in. Zartan makes his own escape, departing with Evening Star in hand (Storm Shadow #4).
          </p>
        </section>
