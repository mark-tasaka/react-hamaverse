    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Cobra Commander hires <Link to="/character-bios/Firefly">Firefly</Link> to engineer the assassination of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, who is living with the Arashikage clan in Japan.  <Link to="/character-bios/Firefly">Firefly</Link> realises he is no match for <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and recommends the use of an outside contractor to carry out the assassination.  Cobra Commander hires Zartan for the job. </p>
           <p> 
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, Croc Master brings his captives — <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and Captain Minh — aboard the freighter, where Fred VII, <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, and Zartan are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing Fred VII of being an imposter responsible for murdering his father, the real Cobra Commander. Voltar demands proof, suggesting perhaps <Link to="/character-bios/Billy">Billy</Link> is the imposter. Mid-argument, the lights go out, and the top hatch opens to reveal the real Cobra Commander and his Crimson Guard, alongside Dr. Mindbender, Raptor, and the Viper excavation team. The real Cobra Commander throws Dr. Mindbender, Raptor, and the excavation team down into the freighter and seals the hatch.
          </p>
          <p>
