    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Zartan — disguised as the <Link to="/character-bios/BlindMaster">Blind Master</Link> — and <Link to="/character-bios/Tyrone">Tyrone</Link> drive to the woods outside Denver, in front of the Rockies, where they find <Link to="/character-bios/Billy">Billy</Link> and Raptor preparing to exhume <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s body. Disgusted, Zartan strikes Raptor and tells <Link to="/character-bios/Billy">Billy</Link> not to let this trash desecrate his father's grave, warning him about the endless cycle of vengeance. <Link to="/character-bios/Billy">Billy</Link> convinces him that the true target of their revenge is the current <Link to="/character-bios/CobraCommander">Cobra Commander</Link> (Issue #95).
          </p>
          <p>
          ...
          <p>
            Shortly after, Raptor confronts Dr. Mindbender privately, describing his trouble controlling the imposter <Link to="/character-bios/CobraCommander">Cobra Commander</Link>, and reveals he knows where the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link> is buried — remains Dr. Mindbender could use to clone a more controllable "competitor." Raptor, Dr. Mindbender, and a team of Vipers depart to exhume the body (Issue #97).
          </p>
          <p>
            The next day, Croc Master brings his captives — <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and Captain Minh — aboard the freighter, where Fred VII, <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, and Zartan are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing Fred VII of being an imposter responsible for murdering his father, the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link>. Voltar demands proof, suggesting perhaps <Link to="/character-bios/Billy">Billy</Link> is the imposter. Mid-argument, the lights go out, and the top hatch opens to reveal the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link> and his Crimson Guard, alongside Dr. Mindbender, Raptor, and the Viper excavation team. The real <Link to="/character-bios/CobraCommander">Cobra Commander</Link> throws Dr. Mindbender, Raptor, and the excavation team down into the freighter and seals the hatch.
          </p>
          <p>
