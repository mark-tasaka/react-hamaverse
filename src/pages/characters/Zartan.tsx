    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, Croc Master brings his captives — <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and <Link to="/character-bios/Minh">Captain Minh</Link> — aboard the freighter, where <Link to="/character-bios/Fred7">Fred VII</Link>, <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, and Zartan are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing <Link to="/character-bios/Fred7">Fred VII</Link> of being an imposter responsible for murdering his father, the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link>. Voltar demands proof, suggesting perhaps <Link to="/character-bios/Billy">Billy</Link> is the imposter. Mid-argument, the lights go out, and the top hatch opens to reveal the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link> and his Crimson Guard, alongside Dr. Mindbender, <Link to="/character-bios/Raptor">Raptor</Link>, and the Viper excavation team. The real <Link to="/character-bios/CobraCommander">Cobra Commander</Link> throws Dr. Mindbender, <Link to="/character-bios/Raptor">Raptor</Link>, and the excavation team down into the freighter and seals the hatch.
          </p>
          <p>
