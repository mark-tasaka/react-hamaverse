    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            In Sierra Gordo, four members of the team — <Link to="/character-bios/Stalker">Stalker</Link>, <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>, Zap, and <Link to="/character-bios/Grunt">Grunt</Link> — are carrying a blinded, severely burned prisoner to the extraction site. At the Pentagon, General Austin voices concerns about the security of the extraction. General Flagg and Sparks activate Shooter (G.I. Joe Declassified #1).
          </p>
          <p>
