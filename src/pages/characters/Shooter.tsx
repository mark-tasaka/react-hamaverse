    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Officially, SFC Craig serves as NCO cadre at the Chaplain's Assistant School at Fort Wadsworth, where she plays an active role keeping snoopy Chaplain's Assistants from poking around the motor pool and bothering its staff — the cover identity for the G.I. Joe team. Shortly after she orders a pair of nosy Chaplain's Assistants back to their duties, giving the motor pool staff some breathing room, Short Fuze, <Link to="/character-bios/Steeler">Steeler</Link>, and <Link to="/character-bios/Flash">Flash</Link> take note of the ribbons and badges on her dress uniform: the Combat Infantryman's Badge (CIB), Expert Rifleman's Badge, Bronze Star, Purple Heart, and Air Medal. The CIB, they note, is only awarded to personnel who've served under direct enemy fire (G.I. Joe Declassified #1).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Years later, certain details of Operation Lady Doomsday are declassified. <Link to="/character-bios/LadyJay">Lady Jaye</Link> and <Link to="/character-bios/CoverGirl">Cover Girl</Link> travel to St. Ewan Church to visit Jodie's mother, presenting her with the Silver Star and Purple Heart Jodie was posthumously awarded for that mission. Mrs. Craig asks, "They give out medals for killing the enemy, don't they? Did my Jodie kill people?"
          </p>
          <p>
            <Link to="/character-bios/LadyJay">Lady Jaye</Link> tells her that Jodie performed her duties with exceptional valor, and that the mission's success hinged on her actions.
          </p>
          <p>
            <Link to="/character-bios/CoverGirl">Cover Girl</Link> quotes John 15:13, telling her, "She gave her life to save the twelve of her comrades." In tears, Mrs. Craig says, "It's such a costly gift..." <Link to="/character-bios/CoverGirl">Cover Girl</Link> embraces her, offering what comfort she can (Issue #228).
          </p>
        </section>
