    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <p className="profile-intro">
          The Hard Master was the head of the Arashikage clan during the time <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> spent training in Japan. He is also Storm Shadow's uncle (Storm Shadow's unnamed, deceased father was the Hard Master's younger brother). At the time of his death, the Hard Master was married to the woman who would become known as Obake Obassan ("Demon Granny").
        </p>
        ...
        <section className="profile-block">
          ...
          <p>
            Two years after his arrival, the Hard Master and his younger brother, the <Link to="/character-bios/SoftMaster">Soft Master</Link>, watch <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Tommy (Storm Shadow) spar. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> allows Tommy to win, so that his friend can save face in front of his uncles. The Hard Master takes note of this.
          </p>
          <p>
            Time passes. One night, the Hard Master is privately teaching <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> the Darkened Room technique. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> hears someone in the courtyard outside. The Hard Master assures him the person poses no danger, then tells <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> that he wishes for him to become heir to the Arashikage clan, in place of Storm Shadow. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> does not want this.
          </p>
          <p>
          ...
          <p>
            <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> tries to save the dying Hard Master. The <Link to="/character-bios/SoftMaster">Soft Master</Link> arrives, having run over from his room, and says he saw Storm Shadow fleeing the courtyard with a bow in hand. With his dying breath, the Hard Master insists that Storm Shadow did not kill him (<Link to="/comic-issues/Issue26">Issue #26</Link>).
          </p>
        </section>
