    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The <Link to="/character-bios/Baroness">Baroness</Link> shoots <Link to="/character-bios/Scarlett">Scarlett</Link> in the head, based on the false belief that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> killed her brother, Eugen (<Link to="/comic-issues/Issue94">Issue #94</Link>). <Link to="/character-bios/Scarlett">Scarlett</Link> falls into a coma, her prognosis unknown. Her lover, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, waits by her side at the hospital, while his friends <Link to="/character-bios/StormShadow">Storm Shadow</Link> and <Link to="/character-bios/Stalker">Stalker</Link> visit regularly to offer support.
          </p>
          <p>
            One day, Sioban O'Hara arrives at the hospital, telling <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> that she has petitioned the courts to end her sister's suffering by terminating her life support (Issue #101). Sioban obtains a court order barring <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> from entering the hospital room. Distressed, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> pushes Sioban aside, enters the room, kneels beside <Link to="/character-bios/Scarlett">Scarlett</Link>'s bed, and whispers her name (Issue #102).
          </p>
          <p>
            To take <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' mind off <Link to="/character-bios/Scarlett">Scarlett</Link>'s seemingly inevitable death, <Link to="/character-bios/StormShadow">Storm Shadow</Link> blackmails the Jugglers into authorizing a mission to send <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> into Borovia to rescue George Strawhacker — the fiancé of his late twin sister — from a gulag. As <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> descends from a B-2 bomber into Borovia, <Link to="/character-bios/Scarlett">Scarlett</Link> wakes from her coma. Sioban, shocked that her sister has woken up, blames the doctors for misleading her (Issue #103).
          </p>
          <p>
