    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Returning from a patrol with Storm Shadow and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, Stalker's LRRP comes under attack as their Huey arrives. Stalker and Storm Shadow board the Huey, but <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is hit before he can reach it. The enemy fire is intense, and believing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' fate is sealed, Stalker orders the Huey to leave. Storm Shadow disobeys the order, runs through a hail of gunfire, and carries the wounded <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> aboard.
          </p>
          <p>
            On the Huey, Storm Shadow removes his wrist wrap — revealing the Arashikage tattoo, the first time Stalker sees it — and uses it to help bandage <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> (Issue #26). Storm Shadow also employs the Arashikage Mindset to help stabilize <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' condition.
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            After the screams of Boris — and of the guards who beat him to death — die down, the barracks door is broken open. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, Storm Shadow, <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/Billy">Billy</Link>, Jinx, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> arrive with assault rifles taken from the bodies of the dead guards. Stalker tells his fellow prisoners these are friends, and the prisoners pick up the rifles.
          </p>
          <p>
