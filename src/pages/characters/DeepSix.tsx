    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Deep Six's first mission takes place aboard a repurposed civilian ship in the Gulf of Mexico, from which two Dragonfly assault helicopters are set to launch. Cutter tells Deep Six to board the S.H.A.R.C. (Submersible High-Speed Attack and Reconnaissance Craft), as he will be launching right after the Dragonflies. Deep Six replies, "Whatever you say, Cutter," in a flat, expressionless monotone, then heads for the S.H.A.R.C. without enthusiasm.
          </p>
          <p>
