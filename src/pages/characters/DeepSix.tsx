    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Deep Six performs admirably in combat. When the Dragonflies and the S.H.A.R.C. return to the ship, <Link to="/character-bios/WildBill">Wild Bill</Link> — who had piloted one of the helicopters — walks over to compliment Deep Six on his shooting and offers a handshake. Deep Six ignores him entirely and walks past. <Link to="/character-bios/WildBill">Wild Bill</Link> is visibly upset, but Airborne holds him back, saying, "Cool it, <Link to="/character-bios/WildBill">Wild Bill</Link>! Deep Six is in a world of his own! He don't mean nothing by it." Cutter adds, "Airborne's right. Depend on Deep Six to do his job. He's the best there is. But don't expect him to be friendly, or even human!" (Issue #25).
          </p>
        </section>
