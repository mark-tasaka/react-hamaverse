    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Beyond his encounters with <Link to="/character-bios/Stalker">Stalker</Link> and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> before the team's formation, Hawk also had dealings with Grand Slam, <Link to="/character-bios/Grunt">Grunt</Link>, and <Link to="/character-bios/Breaker">Breaker</Link> — using each encounter to size up their character. Those qualities are likely what earned each of them a place on his team.
          </p>
          <p>
