    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <p className="profile-intro">
          Clayton Abernathy (Hawk) is one of the original members of G.I. Joe, serving as the team's field commander at the start of the series under Generals Flagg and Austin. According to his file card, Hawk comes from a well-established and wealthy family (reportedly "real loaded") and graduated from West Point at the top of his class. Later in the series, General Austin promotes Hawk to Brigadier General, giving him overall command of G.I. Joe.
        </p>

        <section className="profile-block">
          <h2 className="profile-block-title">The Tragic News for a Returning Veteran at the Airport</h2>
          <img src={hawk1} alt="Hawk delivering tragic news to a returning veteran" className="profile-block-img" />
          <p>
            In the early 1970s, during the Vietnam War, Hawk is stationed behind a desk at headquarters. It falls to him to deliver tragic news to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, a returning veteran waiting at the airport: his family has died in a car accident on their way to pick him up. The drive from headquarters to the airport takes two hours, and Hawk spends the whole trip rehearsing what he'll say a thousand times over. By the time he arrives, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> has already been waiting four hours — and knows, from Hawk's uniform and the look on his face, that tragedy has fallen on his family (Issue #26).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            His answer comes when he sees two of his soldiers hauling in the severely beaten body of the terrorist. Pointing at one of them, Hawk demands, "Are you responsible for this?" The soldier replies, "We wish we had." Hawk soon learns it was the sergeant in charge of security who did this — a tough call that ultimately saved the lives of a thousand children.
          </p>
          <p>
            One of Hawk's superior officers arrives, warning that this will become an international outrage, and demands to know who is responsible. Hawk answers simply, "I am, sir." Later, a Major General chews him out, telling him his sergeant will take the fall. Hawk insists the responsibility runs all the way up the chain of command to the President of the United States, and refuses to abandon his sergeant. Disgusted, the General leaves, telling Hawk the matter is headed to the Provost and JAG.
          </p>
          <p>
            A closed-door court-martial follows, attended by General Flagg and his assistant, Sparks. Hawk continues to stand by his sergeant, telling the court that he would have done the very same thing in the man's place — and that he cannot, in good conscience, let the sergeant take the blame for a decision any officer of sound moral standing would have made. It's an argument that leaves every officer above him morally obligated to fall on the sword alongside him if they won't. General Flagg is impressed, and Hawk is acquitted (G.I. Joe Declassified #1). The sergeant Hawk defends is Lonzo Wilkinson — <Link to="/character-bios/Stalker">Stalker</Link> — who becomes the first member of G.I. Joe that Hawk recruits (G.I. Joe Declassified #1).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Beyond his encounter with <Link to="/character-bios/Stalker">Stalker</Link>, Hawk also crosses paths with Grand Slam, Grunt, and Breaker before G.I. Joe is ever formed.
          </p>
          <p>
            Hawk first meets Grand Slam (James J. Barney) at a mortar range, observing a class where the drill sergeant challenges his students to accurately fire a mortar without computer-assisted targeting. Grand Slam steps forward, carefully surveys the map, uses a protractor to measure the distance between points, a lensatic compass to determine the bearing, and consults the range angle from the 81mm mortar manual's firing table. He fires — hitting the target dead-on in just 23 seconds, drawing praise from the drill instructor. Hawk pulls Grand Slam aside afterward, but instead of praising him, chews him out for failing to double-check his azimuth — a degree or two of error could have meant striking friendly troops.
          </p>
          <p>
            Hawk meets Robert W. Graves (Grunt) while overseeing Advanced Infantry Training. He asks Private Graves about an essay he wrote titled "Why I Would Join an Elite Unit," which quotes Amelia Earhart's line, "Courage is the price life extracts for granting peace." Graves explains he came across the quote at the home of a fellow recruit who'd died in a training accident. Learning that Graves barely knew the soldier, Hawk asks why he'd spend his own leave time and money visiting the mother of someone he hardly knew. Graves replies, "I thought we were to take care of our own, sir."
          </p>
          <p>
            CID (Criminal Investigations Division) catches Specialist Alvin R. Kibbey (Breaker) decrypting top-secret transmissions. Learning that Kibbey is also fluent in seven languages — a skill he developed through ham radio use since age ten — Hawk brings two fully loaded backpacks to the interrogation room and takes Kibbey on a forced march up a mountain. Partway through, Hawk asks if he's having a hard time keeping up; Kibbey simply takes the lead and outpaces him. Hawk tells him he's made his point (G.I. Joe Declassified #2).
          </p>
        </section>
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), six figures of Hawk were produced: the 1982 figure (with a 1983 swivel-arm version), the 1986 figure, the 1991 figure, the 1992 figure, and two 1993 versions (a convention-exclusive release and the Star Brigade version). Hawk's original 1986 file card lists him as an O-6, reflecting his rank as Colonel at the start of the series. Every other file card from the Marvel run except the 1992 version lists his rank as O-7 (Brigadier General), reflecting his promotion by General Austin. The 1992 file card lists him as an O-8 (Major General) — I suspect this was an error, since later Marvel-run file cards revert to O-7. In Issue #301 (the first Skybound ARAH issue), Hawk is identified as a Lieutenant General (O-9). Taken together, this means Hawk received two further promotions following his original elevation to Brigadier General.
          </p>
        </section>
