    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            As they prepare to exhume the grave, <Link to="/character-bios/Tyrone">Tyrone</Link> and the 'Blind Master' (secretly <Link to="/character-bios/Zartan">Zartan</Link> in disguise) arrive. The 'Blind Master' strikes Raptor for desecrating the grave, warning against the cycle of vengeance. <Link to="/character-bios/Billy">Billy</Link> counters that the target of their revenge is the current <Link to="/character-bios/CobraCommander">Cobra Commander</Link> (<Link to="/comic-issues/Issue95">Issue #95</Link>). Rather than exhuming the body, the four travel to the Gulf of Mexico and hire <Link to="/character-bios/Minh">Captain Minh</Link> to take them to Cobra Island.
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            On the beach of Cobra Island, Raptor, <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, the 'Blind Master' (<Link to="/character-bios/Zartan">Zartan</Link>), and <Link to="/character-bios/Minh">Captain Minh</Link> watch <Link to="/character-bios/CobraCommander">Cobra Commander</Link> from a distance. <Link to="/character-bios/Billy">Billy</Link> studies <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s body language and realizes this is actually <Link to="/character-bios/Fred7">Fred VII</Link>. The 'Blind Master' is the first to depart, claiming he needs to scout ahead — though the others don't yet know he is really <Link to="/character-bios/Zartan">Zartan</Link>, planning to confront <Link to="/character-bios/Fred7">Fred VII</Link> himself and send him back to his old life at the Denver garage. Shortly after, Raptor leaves as well.
          </p>
          <p>
          ...
          <p>
            The transport helicopter lands atop the landlocked freighter. <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s Siegies open the freighter's top hatch, revealing <Link to="/character-bios/Fred7">Fred VII</Link>, <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/CrocMaster">Croc Master</Link>, Voltar, <Link to="/character-bios/Firefly">Firefly</Link>, <Link to="/character-bios/Zartan">Zartan</Link>, <Link to="/character-bios/Minh">Captain Minh</Link>, and <Link to="/character-bios/Tyrone">Tyrone</Link> arguing inside. <Link to="/character-bios/CobraCommander">Cobra Commander</Link> announces his return, and his Siegies throw Raptor, Dr. Mindbender, and the Viper excavation team down into the freighter.
          </p>
          <p>
