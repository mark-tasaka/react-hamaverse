    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The transport helicopter lands atop the landlocked freighter. <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s Siegies open the freighter's top hatch, revealing <Link to="/character-bios/Fred7">Fred VII</Link>, <Link to="/character-bios/Billy">Billy</Link>, Croc Master, Voltar, <Link to="/character-bios/Firefly">Firefly</Link>, <Link to="/character-bios/Zartan">Zartan</Link>, Captain Minh, and <Link to="/character-bios/Tyrone">Tyrone</Link> arguing inside. <Link to="/character-bios/CobraCommander">Cobra Commander</Link> announces his return, and his Siegies throw Raptor, Dr. Mindbender, and the Viper excavation team down into the freighter.
          </p>
          <p>
