    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Metz">Metz</Link> fires his machine pistol, killing Strawhacker. Something awakens in the <Link to="/character-bios/SnakeEyes">Hero</Link>, who raises his rifle at <Link to="/character-bios/Metz">Metz</Link>. A mercenary in the crowd reveals that <Link to="/character-bios/Metz">Metz</Link> had hired him to kill the <Link to="/character-bios/SnakeEyes">Hero</Link>, and the mob turns on <Link to="/character-bios/Metz">Metz</Link>, beating him and preparing to hang him.
          </p>
          <p>
            The <Link to="/character-bios/WhiteClown">young girl</Link> begs the <Link to="/character-bios/SnakeEyes">Hero</Link> not to let the mob hang <Link to="/character-bios/Metz">Metz</Link>. Just as the noose tightens, the <Link to="/character-bios/SnakeEyes">Hero</Link>, carrying the girl, shoots the rope in two, and <Link to="/character-bios/Metz">Metz</Link> falls safely to the ground.
          </p>
          <p>
