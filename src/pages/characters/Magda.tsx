    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Political turmoil grips Borovia as Magda is thrown from office. Metz, the opposition leader, allies himself with Cobra and seizes the presidency. Magda and the <Link to="/character-bios/WhiteClown">White Clown</Link> are captured by Vipers and brought before Metz and <Link to="/character-bios/CobraCommander">Cobra Commander</Link>. Metz promises them a fair trial, recalling that his own life had once been spared when the mob tried to hang him.
          </p>
          <p>
            <Link to="/character-bios/CobraCommander">Cobra Commander</Link> disagrees, and guns down Magda and the <Link to="/character-bios/WhiteClown">White Clown</Link> in cold blood. Metz is shocked and horrified (Issue #145).
          </p>
        </section>
