    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Pale Peony attacks <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> inside the convention. He recognizes her fighting style as the esoteric techniques used by specific Yakuza clans, and counters with Arashikage forms. Pale Peony, recognizing the style in turn, switches to non-lethal Arashikage techniques of her own — unwilling to kill a fellow member of the clan. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> takes the Virtual Krytron, appearing as a flash drive, from her.  He allows her to escape as <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> understanding her intention by switching to non-lethal techniques (Issue #181).
          </p>
        </section>
          ...
          <p>
            After fleeing Comic-Con, Pale Peony is captured by a Blue Ninja cyborg and held inside a container while it interrogates her about the whereabouts of a flash drive containing Krythorn. She insists she doesn't know. <Link to="/character-bios/Zarana">Zarana</Link> and <Link to="/character-bios/RoadPig">Road Pig</Link> arrive, destroy the cyborg, and free Pale Peony — revealing they are working together (Issue #181).
          </p>
          <p>
            Back at their safe house, <Link to="/character-bios/Zarana">Zarana</Link> and <Link to="/character-bios/RoadPig">Road Pig</Link> tie Pale Peony upside down, explaining that they were using her as a buffer. Pale Peony breaks free of her bindings and kicks both of them, then demands to cut a new deal with them.
          </p>
          <p>
          ...
          <p>
            Tunnel Rat, Dusty, and Air Tight are operating in Benzheen. Tunnel Rat is captured by the newly formed crew — Pale Peony, <Link to="/character-bios/Zartan">Zartan</Link>, <Link to="/character-bios/Zarana">Zarana</Link>, and <Link to="/character-bios/RoadPig">Road Pig</Link> - while Dusty and Air Tight are captured separately by the local authorities (Issue #184) and sent to a prison outside the city (Issue #185). Pale Peony quietly whispers to Tunnel Rat that she's on his side.
          </p>
          <p>
          ...
          <p>
            A five-man G.I. Joe team led by Lt. Falcon launches an assault on the prison, while the newly formed crew mounts an independent attack of their own (Issue #186). Pale Peony is wounded, taking a bullet meant for <Link to="/character-bios/RoadPig">Road Pig</Link>. <Link to="/character-bios/RoadPig">Road Pig</Link> carries her unconscious body, refusing to abandon her. When the Tomahawk arrives with reinforcements, he hands Pale Peony to Lifeline, as she will need immediate medical treatment to keep her alive (Issue #187).
          </p>
        </section>
