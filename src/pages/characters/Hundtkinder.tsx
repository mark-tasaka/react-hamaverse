    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <p className="profile-intro">
          Dr. Hundtkinder is a renowned plastic surgeon at the Bern Institute of Reconstructive Surgery in Switzerland. He performs the surgery that restores the Baroness' face after she is severely burned, and years later performs reconstructive surgery on <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. The good doctor violates his Hippocratic Oath of patient confidentiality, revealing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' surgery to the Baroness.
        </p>
