    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Captain Minh does not die in the explosion. He survives and swims to Cobra Island, where he lives in the swamps, surviving on small prey and staying clear of <Link to="/character-bios/CrocMaster">Croc Master</Link>, who patrols the area (Issue #72).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            The 'Blind Master' is the first to leave the group, saying he is going to scout ahead, followed shortly after by <Link to="/character-bios/Raptor">Raptor</Link>. When night falls, the remaining trio is attacked by Night Vipers, and Captain Minh's ship is destroyed. Captain Minh leads the group into the drainage system beneath the island, where they are captured by <Link to="/character-bios/CrocMaster">Croc Master</Link> and his pets (Issue #97).
          </p>
          <p>
            The next day, <Link to="/character-bios/CrocMaster">Croc Master</Link> brings his prisoners aboard the landlocked freighter, where <Link to="/character-bios/Fred7">Fred VII</Link>, <Link to="/character-bios/Zartan">Zartan</Link>, Voltar, and <Link to="/character-bios/Firefly">Firefly</Link> are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing <Link to="/character-bios/Fred7">Fred VII</Link> of being an imposter and Voltar accusing <Link to="/character-bios/Billy">Billy</Link> of being the fake. The lights suddenly go out, and the hatch opens to reveal the original <Link to="/character-bios/CobraCommander">Cobra Commander</Link> and his loyal Crimson Guard standing above, alongside Dr. Mindbender, <Link to="/character-bios/Raptor">Raptor</Link>, and the Viper excavation team.
          </p>
          <p>
