    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, Croc Master brings his prisoners aboard the landlocked freighter, where <Link to="/character-bios/Fred7">Fred VII</Link>, <Link to="/character-bios/Zartan">Zartan</Link>, Voltar, and <Link to="/character-bios/Firefly">Firefly</Link> are waiting. An argument breaks out, with <Link to="/character-bios/Billy">Billy</Link> accusing <Link to="/character-bios/Fred7">Fred VII</Link> of being an imposter and Voltar accusing <Link to="/character-bios/Billy">Billy</Link> of being the fake. The lights suddenly go out, and the hatch opens to reveal the original <Link to="/character-bios/CobraCommander">Cobra Commander</Link> and his loyal Crimson Guard standing above, alongside Dr. Mindbender, <Link to="/character-bios/Raptor">Raptor</Link>, and the Viper excavation team.
          </p>
          <p>
