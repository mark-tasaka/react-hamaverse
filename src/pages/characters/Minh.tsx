    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Raptor">Raptor</Link>, the <Link to="/character-bios/BlindMaster">Blind Master</Link> (<Link to="/character-bios/Zartan">Zartan</Link>), and <Link to="/character-bios/Tyrone">Tyrone</Link> hire Captain Minh to take them to Cobra Island. On the beach, the five watch Cobra Commander interacting with potential weapons buyers outside the landlocked freighter. <Link to="/character-bios/Billy">Billy</Link> studies Cobra Commander's body language and realizes this is not his father. <Link to="/character-bios/Raptor">Raptor</Link> informs him it is actually <Link to="/character-bios/Fred7">Fred VII</Link>.
          </p>
          <p>
            The <Link to="/character-bios/BlindMaster">Blind Master</Link> is the first to leave the group, saying he is going to scout ahead, followed shortly after by <Link to="/character-bios/Raptor">Raptor</Link>. When night falls, the remaining trio is attacked by Night Vipers, and Captain Minh's ship is destroyed. Captain Minh leads the group into the drainage system beneath the island, where they are captured by Croc Master and his pets (Issue #97).
          </p>
          <p>
