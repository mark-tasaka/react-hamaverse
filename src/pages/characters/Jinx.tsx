    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Billy">Billy</Link> meet <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> at the <Link to="/character-bios/WhiteClown">White Clown</Link>'s circus troupe. The six raid Gulag 23, which houses <Link to="/character-bios/Stalker">Stalker</Link>, Snow Job, and Quick Kick. They infiltrate the gulag, kill the guards, and free the prisoners, including the three Joes. They commandeer an army truck and travel to the border, where they discover a barbed-wire fence and guard towers lining the river bordering Borovia. Fortunately, the <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky arrive from the circus, their car hauling the circus cannon. The <Link to="/character-bios/WhiteClown">White Clown</Link> fires them across the fence into the river, allowing their escape from Borovia (Issue #66). Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Billy">Billy</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> return to San Francisco.
          </p>
        </section>
