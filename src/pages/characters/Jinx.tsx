    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            When the truck leaves the facility, it's followed by <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, Roadblock, and Gerry McCarthy — a local authority working with the Joes. Jinx manages to free her hands, and together the two women kick their way free of the boxes, sending them off the flatbed, over the bridge, and into the water below. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Scarlett">Scarlett</Link> dive in after them, and all four swim to the surface.
          </p>
          <p>
            On the bridge, Roadblock and McCarthy are already engaged with the truck's driver — another Revanche cyborg. Jinx, <Link to="/character-bios/PalePeony">Pale Peony</Link>, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and <Link to="/character-bios/Scarlett">Scarlett</Link> join the fight, but the cyborg self-destructs, vaporizing <Link to="/character-bios/PalePeony">Pale Peony</Link> and reducing her to ash. Shocked, Jinx stares at what remains of her friend as Roadblock tries to comfort her. She tells the others the cyborg had called itself 921 — Ku-no-Ichi in Japanese, the term for a female ninja (Issue #207).
          </p>
          <p>
            Jinx joins <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, Roadblock, and McCarthy to exact revenge on Revanche. Storming the headquarters, they battle 921 and discover that a human body inside a stasis chamber is what's actually controlling the cyborg. Roadblock destroys the chamber, killing 921 for good. They return to the Pit carrying <Link to="/character-bios/PalePeony">Pale Peony</Link>'s ashes.  <Link to="/character-bios/StormShadow">Storm Shadow</Link> infiltrates the base and tells them he's taking her ashes to Obake Obassan (Issue #208).
          </p>
        </section>
