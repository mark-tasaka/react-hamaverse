...
import jinx12 from './img/jinx/jinx_12.png';
    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Billy">Billy</Link> meet <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> at the <Link to="/character-bios/WhiteClown">White Clown</Link>'s circus troupe. The six raid Gulag 23, which houses <Link to="/character-bios/Stalker">Stalker</Link>, Snow Job, and Quick Kick. They infiltrate the gulag, kill the guards, and free the prisoners, including the three Joes. They commandeer an army truck and travel to the border, where they discover a barbed-wire fence and guard towers lining the river bordering Borovia. Fortunately, the <Link to="/character-bios/WhiteClown">White Clown</Link> and <Link to="/character-bios/Orlovsky">Orlovsky</Link> arrive from the circus, their car hauling the circus cannon. The <Link to="/character-bios/WhiteClown">White Clown</Link> fires them across the fence into the river, allowing their escape from Borovia (Issue #66). Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Billy">Billy</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> return to San Francisco.
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            When Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Billy">Billy</Link> arrive at Dulles Airport, Domestic Operations Agency (DOA) agents arrest the trio and cuff them. As they're escorted outside, they spot <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> in a car, calling out to them. The three ninjas slip out of their cuffs, knock out the DOA agents, and board the car.
          </p>
          <p>
            They drive to Dr. Adele Burkhart's home, where they meet Roadblock, <Link to="/character-bios/Grunt">Grunt</Link> (now a civilian), and his girlfriend, <Link to="/character-bios/Lola">Lola</Link> (a former service member). <Link to="/character-bios/CoverGirl">Cover Girl</Link>, Dusty, Bazooka, Barbecue, <Link to="/character-bios/Flash">Flash</Link>, Wet-Suit, Snow Job, <Link to="/character-bios/Steeler">Steeler</Link>, and <Link to="/character-bios/Zap">Zap</Link> later arrive at the house. The Joes mount a raid on the hospital; Dr. Burkhart insists on coming along. Film crews are active inside when <Link to="/character-bios/Hawk">Hawk</Link> and Hollingsworth are cleared, with the arrival of Destro, who presents receipts from MARS on camera, clearing the Joes of wrongdoing (Issue #78).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Jinx and <Link to="/character-bios/StormShadow">Storm Shadow</Link> invite <Link to="/character-bios/Billy">Billy</Link>'s mother to stay for dinner. They learn of <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s older brother, Dan, a Vietnam veteran who extended his tours in-country to keep his younger brother from being sent overseas. When Dan returned home from the war, he began driving erratically, as if searching for death behind the wheel — and it was Dan who killed <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' family in the car crash that <Link to="/character-bios/CobraCommander">Cobra Commander</Link> later blamed on <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. <Link to="/character-bios/Billy">Billy</Link>'s mother says she has been searching for him for years and has kept a room ready for him in her Berkeley apartment. After dinner, <Link to="/character-bios/Billy">Billy</Link> departs with his mother, leaving <Link to="/character-bios/StormShadow">Storm Shadow</Link> and Jinx behind (Issue #84).
          </p>
        </section>

        <section className="profile-block">
          <h2 className="profile-block-title"><Link to="/character-bios/Zartan">Zartan</Link>'s Attack</h2>
          <img src={jinx7} alt="<Zartan'sattack on Jinx and Storm Shadow" className="profile-block-img" />
          <p>
            <Link to="/character-bios/Zartan">Zartan</Link> believes <Link to="/character-bios/StormShadow">Storm Shadow</Link> will seek revenge on him for killing the <Link to="/character-bios/HardMaster">Hard Master</Link>. Deciding to strike first, he suspects <Link to="/character-bios/StormShadow">Storm Shadow</Link> or Jinx will be at a feudal Japanese museum exhibit in San Francisco, and departs for the city with a group of Red Ninja (Issue #84).
          </p>
          <p>
            In the museum, <Link to="/character-bios/Zartan">Zartan</Link> — disguised as a bearded middle-aged man — waits in a telephone booth, monitoring the numbers dialed from the adjacent booths. Jinx enters the museum and spots a sword bearing the Arashikage symbol. She enters one of the booths and calls <Link to="/character-bios/StormShadow">Storm Shadow</Link> at the dojo. <Link to="/character-bios/Zartan">Zartan</Link> obtains <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s number and learns where he's staying, then departs and signals the three Red Ninja disguised as samurai museum exhibits.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Jinx and <Link to="/character-bios/PalePeony">Pale Peony</Link> return to the Pit in style, arriving in a red convertible. Once they reach the lower levels, they brief <Link to="/character-bios/Hawk">Hawk</Link> on everything they uncovered in Ollistan (Issue #201).
                ...
                <section className="profile-block">
          <h2 className="profile-block-title">Revanche Headquarters, Dublin</h2>
          <img src={jinx12} alt="Jinx and Pale Peony infiltrating Revanche Headquarters in Dublin" className="profile-block-img" />
          <p>
            Jinx and <Link to="/character-bios/PalePeony">Pale Peony</Link> infiltrate Revanche Headquarters in Dublin after hours. Inside, they encounter a cyborg identifying itself as 921, who defeats the women, knocks them unconscious, and takes them prisoner (Issue #206). They wake up bound, sealed in separate container boxes on the back of a flatbed truck.
          </p>
          <p>
            When the truck leaves the facility, it's followed by <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, Roadblock, and Gerry McCarthy — a local authority working with the Joes. Jinx manages to free her hands, and together the two women kick over the boxes, sending them off the flatbed, over the bridge, and into the water below. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Scarlett">Scarlett</Link> dive in after them and free them from the boxes. All four swim to the surface.
          </p>
          <p>
