    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Billy">Billy</Link> meets Hawk and others at a secret location beneath the Defense Language Institute. There, he also meets <Link to="/character-bios/StormShadow">Storm Shadow</Link> and continues his training as <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s apprentice (Issue #63).
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            In the aftermath of the Joes' participation in the Cobra Civil War on Cobra Island, the Joes are relieved from active duty and placed under arrest pending an investigation (Issue #77). Hawk and General Hollingsworth are imprisoned in a hospital in rural Virginia. In San Francisco, Jinx accesses the central payroll computer and tracks Hawk and Hollingsworth to the hospital. Jinx, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Billy">Billy</Link> catch a flight to Washington, D.C.
          </p>
          <p>
