    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            They drive to Dr. Adele Burkhart's home, where they meet Roadblock, <Link to="/character-bios/Grunt">Grunt</Link> (now a civilian), and his girlfriend, <Link to="/character-bios/Lola">Lola</Link> (a former service member). Cover Girl, Dusty, Bazooka, Barbecue, <Link to="/character-bios/Flash">Flash</Link>, Wet-Suit, Snow Job, <Link to="/character-bios/Steeler">Steeler</Link>, and <Link to="/character-bios/Zap">Zap</Link> later arrive at the house. The Joes mount a raid on the hospital; Dr. Burkhart insists on coming along. Film crews are active inside when <Link to="/character-bios/Hawk">Hawk</Link> and Hollingsworth are cleared, with the arrival of Destro, who presents receipts from MARS on camera, clearing the Joes of wrongdoing (Issue #78).
          </p>
        </section>
