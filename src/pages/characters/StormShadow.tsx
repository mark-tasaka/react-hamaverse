    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Storm Shadow and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> steal one of the <Link to="/character-bios/Baroness">Baroness</Link>' Rattlers from her New York safehouse and fly to Cobra Island to confront the <Link to="/character-bios/HardMaster">Hard Master</Link>'s killer (Issue #45). The Rattler lands on Cobra Island, and the two dispatch the ground crew before making their way to the Terror Drome. Inside, they cut a path through Cobra troopers until they reach the launch chamber, where they find <Link to="/character-bios/Zartan">Zartan</Link> in the Firebat (a vertical-launch vehicle), with an unmasked Crimson Guardsman — Professor Apel — preparing the launch.
          </p>
          <p>
            Storm Shadow slashes Professor Apel, wounding him. As he moves to strike the Firebat's cockpit, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> pulls him back, saving him from the blast of the Firebat's rockets as it takes off. Professor Apel dies in the explosion. Neither Storm Shadow nor <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> realizes the Firebat's true occupant isn't <Link to="/character-bios/Zartan">Zartan</Link> — it's <Link to="/character-bios/RipCord">Rip Cord</Link>. <Link to="/character-bios/Zartan">Zartan</Link> had confronted <Link to="/character-bios/RipCord">Rip Cord</Link> on the island earlier, and both were wounded in the encounter; <Link to="/character-bios/Zartan">Zartan</Link> then disguised <Link to="/character-bios/RipCord">Rip Cord</Link> in his own cloth and used his holographic powers to assume <Link to="/character-bios/RipCord">Rip Cord</Link>'s identity (Issue #46).
          </p>
          <p>
