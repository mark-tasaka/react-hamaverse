    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Storm Shadow slashes Professor Apel, wounding him. As he moves to strike the Firebat's cockpit, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> pulls him back, saving him from the blast of the Firebat's rockets as it takes off. Professor Apel dies in the explosion. Neither Storm Shadow nor <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> realizes the Firebat's true occupant isn't <Link to="/character-bios/Zartan">Zartan</Link> — it's Rip Cord. <Link to="/character-bios/Zartan">Zartan</Link> had confronted Rip Cord on the island earlier, and both were wounded in the encounter; <Link to="/character-bios/Zartan">Zartan</Link> then disguised Rip Cord in his own cloth and used his holographic powers to assume Rip Cord's identity (Issue #46).
          </p>
          <p>
            G.I. Joe launches a raid on the island to recover Rip Cord. Storm Shadow and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> battle their way to the beach, dispatching Cobra troopers along the way, and commandeer a Cobra Moray hydrofoil. The Moray is struck by a torpedo, sending it out of control, and a pair of Cobra Eels boards the ship. When the Moray crashes against the rocks, everyone is thrown overboard — and a school of sharks attacks. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> kills one with his knife just as a speedboat carrying <Link to="/character-bios/Hawk">Hawk</Link>, Beach Head, and Wet-Suit arrives; <Link to="/character-bios/Hawk">Hawk</Link> and Beach Head pull him aboard.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            In a secret base beneath the Defense Language Institute in San Francisco, Storm Shadow and Rip Cord wait for <Link to="/character-bios/Billy">Billy</Link> inside the recreation room. The door opens, and <Link to="/character-bios/Hawk">Hawk</Link> appears with <Link to="/character-bios/Billy">Billy</Link>. Storm Shadow sees that <Link to="/character-bios/Billy">Billy</Link> now has a prosthetic leg and a patch over one eye, and starts to apologize — but <Link to="/character-bios/Billy">Billy</Link> waves him off, joking that he still has one of each to spare. <Link to="/character-bios/Billy">Billy</Link> sits down and tells Storm Shadow and Rip Cord the unfortunate fate of the <Link to="/character-bios/SoftMaster">Soft Master</Link> and <Link to="/character-bios/Candy">Candy Apel</Link> Apel, both of whom died in the car explosion.
          </p>
          <p>
