    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Storm Shadow slashes Professor Apel, wounding him. As he moves to strike the Firebat's cockpit, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> pulls him back, saving him from the blast of the Firebat's rockets as it takes off. Professor Apel dies in the explosion. Neither Storm Shadow nor <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> realizes the Firebat's true occupant isn't <Link to="/character-bios/Zartan">Zartan</Link> — it's Ripcord. <Link to="/character-bios/Zartan">Zartan</Link> had confronted Ripcord on the island earlier, and both were wounded in the encounter; <Link to="/character-bios/Zartan">Zartan</Link> then disguised Ripcord in his own cloth and used his holographic powers to assume Ripcord's identity (Issue #46).
          </p>
          <p>
