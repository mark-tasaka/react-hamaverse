    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            A week later, Storm Shadow reaches the cabin, much of it destroyed from an earlier conflict involving <Link to="/character-bios/FredBroca">Fred Broca</Link>, Destro, and Firefly. He finds the trap door leading to the underground bunker, where Timber appears. The two bond, and Storm Shadow begins his process of healing (Issue #52).
          </p>
        </section>
