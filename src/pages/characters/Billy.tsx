    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Storm Shadow begins training Billy in the way of the ninja. Time passes; Billy's skill and technique improve. Storm Shadow tells him about the assassination of his uncle, the <Link to="/character-bios/HardMaster">Hard Master</Link>. Billy vows that one day he will confront his father, Cobra Commander, and learn who murdered his uncle. One day, Storm Shadow returns to the dojo to find a note from Billy, thanking him and explaining that he's going home to confront his past — and part of Storm Shadow's — asking for his forgiveness for leaving this way. Setting the letter down, Storm Shadow says, "There is nothing to forgive, Billy" (Issue #42).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            The <Link to="/character-bios/BlindMaster">Blind Master</Link> tells Billy he must pass a test. "Test?" Billy asks, just as <Link to="/character-bios/Jinx">Jinx</Link> enters. She tells him they know about Fred and the suit of armor he built. <Link to="/character-bios/Jinx">Jinx</Link> draws her sword and swings it at Billy; he catches it between his hands, using the technique Storm Shadow taught him. Billy then grabs <Link to="/character-bios/Jinx">Jinx</Link> and reveals the Arashikage tattoo on her right forearm, noting that the man who gave him his own test bore the same mark (Issue #60).
          </p>
          <p>
          ...
          <p>
            Billy and <Link to="/character-bios/Jinx">Jinx</Link> continue training. While sparring, he demands to know how her tattoo connects her to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Storm Shadow. The <Link to="/character-bios/BlindMaster">Blind Master</Link> shows Billy a framed photo taken fifteen years earlier: the <Link to="/character-bios/BlindMaster">Blind Master</Link>, Professor Onihashi, Onihashi's assistant (a student of the extinct Koga clan), an eight-year-old <Link to="/character-bios/Jinx">Jinx</Link>, Storm Shadow, the <Link to="/character-bios/HardMaster">Hard Master</Link>, the <Link to="/character-bios/SoftMaster">Soft Master</Link>, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. The <Link to="/character-bios/BlindMaster">Blind Master</Link> explains that <Link to="/character-bios/Jinx">Jinx</Link> is Storm Shadow's second cousin on her mother's side — they are all one big family.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Billy travels with Storm Shadow and <Link to="/character-bios/Jinx">Jinx</Link> to Borovia, where they meet up with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> at the circus troupe. Storm Shadow tells them where <Link to="/character-bios/Stalker">Stalker</Link>, Snow Job, and Quick Kick are being held. The six raid Gulag 23, dispatch the guards, liberate the camp, and rescue the three captured Joes.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Storm Shadow, <Link to="/character-bios/Jinx">Jinx</Link>, and Billy return to San Francisco, where Billy resumes his training. A few years pass. One day, <Link to="/character-bios/Jinx">Jinx</Link> enters the dojo held at gunpoint by a woman demanding to know where Billy is. Billy recognizes his mother's voice and stops Storm Shadow from attacking. He tells her he believed she had died in a car accident years earlier; she replies that she never stopped searching for him.
          </p>
          <p>
            Storm Shadow and <Link to="/character-bios/Jinx">Jinx</Link> invite Billy's mother to stay for dinner. She recounts the past, revealing that her ex-husband had an older brother, Dan — a Vietnam War veteran who extended his tours so that his younger brother (the man who would become Cobra Commander) wouldn't be drafted. When Dan returned home, he began driving erratically at high speeds on the interstate, as if searching for death. One day, he crashed into a family on their way to the airport to meet their son, a returning soldier — everyone in the car was killed. Storm Shadow reveals that the family was <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>'. Billy's mother explains that her ex-husband twisted the tragedy in his mind, blaming the returning soldier for his brother's death.
          </p>
          <p>
