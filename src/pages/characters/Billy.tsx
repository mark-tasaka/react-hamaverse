    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Jinx">Jinx</Link> takes Billy to a private booth in the Defense Language Institute. A secret elevator beneath the booth carries him below, where he meets Hawk, Chuckles, Law, and Order. Billy shares information with the Joes while protecting his father. Hawk brings him to another room, where he meets <Link to="/character-bios/StormShadow">Storm Shadow</Link> and Ripcord. Billy tells them both that the <Link to="/character-bios/SoftMaster">Soft Master</Link> and Candy Apel died when the car was struck by the missile (Issue #63).
          </p>
          <p>
