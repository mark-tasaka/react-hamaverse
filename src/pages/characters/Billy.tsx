    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The <Link to="/character-bios/Baroness">Baroness</Link> and Major Bludd plan to use Billy to assassinate Cobra Commander at an upcoming rally. They convince Billy to pose as a Cobra youth presenting Cobra Commander with a bouquet of flowers at the event. They give him a pistol to conceal among the flowers, instructing him to shoot the Commander at point-blank range (Issue #31).
          </p>
          <p>
            Destro discovers the <Link to="/character-bios/Baroness">Baroness</Link>' plan to use a child to assassinate Cobra Commander. In private, the two discuss it — the <Link to="/character-bios/Baroness">Baroness</Link> says there's no other way, since Major Bludd is committed to the plan, and deterring him could put both her and Destro in jeopardy.
          </p>
          <p>
            At the rally, Billy approaches Cobra Commander with a troupe of Cobra youths, carrying the bouquet. Destro spots Billy from the bleachers and rushes toward him. <Link to="/character-bios/StormShadow">Storm Shadow</Link>, guarding Cobra Commander, wonders why one of the Cobra youths is sweating so heavily. As Billy finishes reciting a poem, he draws the pistol from the bouquet. Just as <Link to="/character-bios/StormShadow">Storm Shadow</Link> is about to cut him down, Destro shoves <Link to="/character-bios/StormShadow">Storm Shadow</Link> aside and knocks the gun from Billy's hand. Destro grabs Billy by the arm and brings him before Cobra Commander, saying he will not abide patricide. Cobra Commander and Billy look at each other. Cobra Commander says, "Billy?" Billy says, "Dad?" (Issue #33).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link> and <Link to="/character-bios/Jinx">Jinx</Link> invite Billy's mother to stay for dinner. She recounts the past, revealing that her ex-husband had an older brother, Dan — a Vietnam War veteran who extended his tours so that his younger brother (the man who would become Cobra Commander) wouldn't be drafted. When Dan returned home, he began driving erratically at high speeds on the interstate, as if searching for death. One day, he crashed into a family on their way to the airport to meet their son, a returning soldier — everyone in the car was killed. <Link to="/character-bios/StormShadow">Storm Shadow</Link> reveals that the family was <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>'. Billy's mother explains that her ex-husband twisted the tragedy in his mind, blaming the returning soldier for his brother's death.
          </p>
          <p>
