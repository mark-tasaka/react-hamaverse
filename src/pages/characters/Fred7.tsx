    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, <Link to="/character-bios/CrocMaster">Croc Master</Link> brings <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and <Link to="/character-bios/Minh">Captain Minh</Link> aboard the freighter. An argument breaks out among Fred VII, <Link to="/character-bios/Zartan">Zartan</Link>, <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, <Link to="/character-bios/CrocMaster">Croc Master</Link>, <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and <Link to="/character-bios/Minh">Captain Minh</Link> — <Link to="/character-bios/Billy">Billy</Link> accusing Fred VII of being an imposter, Voltar accusing <Link to="/character-bios/Billy">Billy</Link> of the same. The lights suddenly go out, and the top hatch of the freighter opens to reveal the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link>.
          </p>
          <p>
