    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Fred VII builds <Link to="/character-bios/Billy">Billy</Link>'s prosthetic leg. Around this time, Fred VII's associate, Raptor, arrives and meets <Link to="/character-bios/CobraCommander">Cobra Commander</Link> for the first time — <Link to="/character-bios/CobraCommander">Cobra Commander</Link> unimpressed, calling him as a lunatic dressed up as a bird (Issue #59).
          </p>
          <p>
          ...
          <p>
            After <Link to="/character-bios/Billy">Billy</Link> leaves, <Link to="/character-bios/CobraCommander">Cobra Commander</Link> decides to abandon Cobra, start an honest life, and win back his son's respect. Fred VII is furious — he had undergone plastic surgery and given up so much for the organization. As <Link to="/character-bios/CobraCommander">Cobra Commander</Link> walks out of the lab, Fred VII shoots him in the back, then picks up the battle armor helmet and remarks that anyone could be inside it (Issue #61). Fred VII and Raptor bury <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s body outside Denver (Issue #62).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Fred VII hires Captain Minh to transport him, the battle armor, and the Cobra Pogo to Cobra Island (Issue #63). In the waters outside the island, Captain Minh's ship is attacked by Cobra Mambas. Fred VII escapes aboard the Pogo as the ship explodes behind him. The Pogo lands on the island, and Fred VII declares himself <Link to="/character-bios/CobraCommander">Cobra Commander</Link>.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, Croc Master brings <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and Captain Minh aboard the freighter. An argument breaks out among Fred VII, <Link to="/character-bios/Zartan">Zartan</Link>, <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, Croc Master, <Link to="/character-bios/Billy">Billy</Link>, <Link to="/character-bios/Tyrone">Tyrone</Link>, and Captain Minh — <Link to="/character-bios/Billy">Billy</Link> accusing Fred VII of being an imposter, Voltar accusing <Link to="/character-bios/Billy">Billy</Link> of the same. The lights suddenly go out, and the top hatch of the freighter opens to reveal the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link>.
          </p>
          <p>
            <Link to="/character-bios/CobraCommander">Cobra Commander</Link> arrives with his Crimson Guard, holding Dr. Mindbender, Raptor, and a Viper excavation team as prisoners. He blames <Link to="/character-bios/Billy">Billy</Link> for walking out on him, driving him to his irrational choice to go straight, and disowns him as his son. He and the Crimson Guard throw Dr. Mindbender, Raptor, and the excavation team into the freighter, then board a transport helicopter. <Link to="/character-bios/CobraCommander">Cobra Commander</Link> detonates a series of preplanned explosions, diverting a water channel to sink the freighter into an extinct volcano — further explosions bury it deep within, trapping everyone above it (Issue #98). In time, Fred VII and most of the others aboard the freighter die of botulism from tainted rations (Issue #116). Only <Link to="/character-bios/Zartan">Zartan</Link>, <Link to="/character-bios/Billy">Billy</Link>, and <Link to="/character-bios/Firefly">Firefly</Link> manage to escape.
          </p>
        </section>
