    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          <h2 className="profile-block-title">A Fatal Mistake</h2>
          <img src={scrapIron1} alt="Scrap-Iron's fatal mistake in Springfield" className="profile-block-img" />
          <p>
            Scrap-Iron is riding on the back of a Cobra Ferret ATV in Springfield when the crew comes across Buzzer, marking the first meeting between the two. Buzzer catches a ride with them. The trio drive past the Cobra police station just as an officer is thrown through the window and an old man — the <Link to="/character-bios/SoftMaster">Soft Master</Link> — bursts out with uncanny speed. The <Link to="/character-bios/SoftMaster">Soft Master</Link> commandeers a police car and drives off.
          </p>
          <p>
            The Ferret pursues the stolen police car. Firefly fires a missile from the Ferret, but the <Link to="/character-bios/SoftMaster">Soft Master</Link> avoids it by ducking under a moving semi-truck, which shears off the top of his car in the process. He then drives across a set of train tracks, narrowly avoiding an oncoming train — which conveniently blocks the pursuing Ferret's path behind him.
          </p>
          <p>
            On the other side of the tracks, the drunk driver who had dropped off the <Link to="/character-bios/SoftMaster">Soft Master</Link> is now heading back toward Springfield to return his forgotten suitcase. His passengers are <Link to="/character-bios/Candy">Candy Appel</Link> and <Link to="/character-bios/Billy">Billy</Link>. Intoxicated, the driver crashes into a pole, knocking all three unconscious.
          </p>
          <p>
            The <Link to="/character-bios/SoftMaster">Soft Master</Link> stops his car, gets out, and checks on the crash victims. At that moment, Scrap-Iron climbs a pole on the opposite side of the tracks and aims his dual missile launcher at the wrecked car. The <Link to="/character-bios/SoftMaster">Soft Master</Link> rushes forward, using his own body as a shield, and dies in the blast. Scrap-Iron fires his second missile, destroying the car entirely (Issue #43) — unaware of who the victims inside actually are. The driver and <Link to="/character-bios/Candy">Candy Appel</Link> are killed. <Link to="/character-bios/Billy">Billy</Link> survives, but loses an eye and a leg and falls into a coma.
          </p>
        </section>
        ...
        <section className="profile-notes">
          ...
          <p>
            During the Marvel run (1982–1994), a single version of Scrap-Iron was produced: the 1984 version.
          </p>
        </section>
