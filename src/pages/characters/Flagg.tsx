  ...
  return (
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          <h2 className="profile-block-title">Recruiting Flash</h2>
        ...
        <section className="profile-block">
          <h2 className="profile-block-title">Activation of G.I. Joe for Operation Lady Doomsday</h2>
          <img src={flagg5} alt="The activation of G.I. Joe for Operation Lady Doomsday" className="profile-block-img" />
          <p>
          ...
          <p>
            In the Pentagon, Major General Austin and General Flagg discuss the situation. Both know a direct frontal assault using regular forces could turn into a bloodbath for their side. General Flagg suggests that a botched rescue mission, forcing Cobra's hand into killing Dr. Burkhart, might be the best course of action. General Austin counters, "Dr. Burkhart's death would be a political embarrassment for the U.S. A rescue mission is needed."
          </p>
          <p>
        ...
        <section className="profile-block">
          <h2 className="profile-block-title">Jodie "Shooter" Craig's Memorial Service</h2>
          <img src={flagg6} alt="Jodie Shooter Craig's memorial service" className="profile-block-img" />
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            The G.I. Joe modular headquarters, located above the Pit at Fort Wadsworth, comes under attack. Major Bludd, Scarface, and a comatose <Link to="/character-bios/Baroness">Baroness</Link> are being held prisoner inside. A Cobra trooper flies a F.A.N.G. helicopter to the roof of the headquarters and plants explosives. Major Bludd and Scarface each have one hand chained to the bars of their cell. Major Bludd kicks Doc, knocking him to the floor, while Scarface kicks the gun from General Flagg's hand. Major Bludd grabs the weapon, shoots General Flagg, and seizes the keys from Doc. He unlocks his cuffs and departs with the <Link to="/character-bios/Baroness">Baroness</Link>, leaving Scarface behind.
          </p>
          <p>
            Doc lifts the badly wounded Flagg and tries to escape. Scarface shouts at Doc to free him as well, but Doc tells him Major Bludd took the keys. Doc gets General Flagg out just before the base explodes, but General Flagg succumbs to his wounds soon after (Issue #20). He is buried with full honors at Arlington National Cemetery (Issue #22).
          </p>
        </section>

        <section className="profile-notes">
          <h2 className="profile-notes-title">Notes from the Field</h2>
          <img src={flagg8} alt="Notes on General Flagg" className="profile-block-img" />
          <p>
