    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            An undisclosed amount of time passes since the Collins family fled Cobra. While undergoing plastic surgery at the Bern Institute in Switzerland, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is captured by the Baroness and taken to the sublevels of the Cobra Consulate in New York City. Wade rejoins his old LRRP teammates, <Link to="/character-bios/Stalker">Stalker</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link>, in New York to help rescue him.
          </p>
          <p>
            Dressed in his old Crimson Guard uniform, Wade enters the Consulate seeking a meeting with the Baroness — walking into a scene of panic, since <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> has already escaped. A Tele-Viper at the front desk tells him the Baroness can't see him; an emergency is underway. Wade leaves and returns to the newsstand across the street, where <Link to="/character-bios/Stalker">Stalker</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> are waiting. As he changes into his military fatigues, a powerful explosion tears through the Consulate's lobby.
          </p>
          <p>
            Wade, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Stalker">Stalker</Link> rush inside to find the lobby filled with dead and dying Vipers, including a Techno-Viper relaying the situation over a microphone as he dies. Just then, the elevator doors open, and a crowd of panicked Cobra civilian employees pours out, sweeping the three of them along in the rush to the street. More explosions rip through the floors above. <Link to="/character-bios/Stalker">Stalker</Link> realizes it's <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' plan: empty the Consulate, seal off the lower levels, and fight his way up (Issue #95).
          </p>
          <p>
          ...
          <p>
            By the time the Tomahawk reaches the Consulate, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> are helping the Baroness board a Cobra transport helicopter. After pulling the Baroness to safety, Destro reaches out for <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> — but the ledge beneath them gives way, sending them both falling. The Tomahawk executes a barrel roll and catches them in midair (Issue #96).
          </p>
          <p>
            Wade spends an unspecified stretch of time in New York, keeping long hours at the hospital where <Link to="/character-bios/Scarlett">Scarlett</Link> is recovering, supporting his old LRRP friends (Issue #97).
          </p>
        </section>
