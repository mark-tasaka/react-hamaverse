    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Wade, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and <Link to="/character-bios/Stalker">Stalker</Link> rush inside to find the lobby filled with dead and dying Vipers, including a Techno-Viper relaying the situation over a microphone as he dies. Just then, the elevator doors open, and a crowd of panicked Cobra civilian employees pours out, sweeping the three of them along in the rush to the street. More explosions rip through the floors above. <Link to="/character-bios/Stalker">Stalker</Link> realizes it's <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' plan: empty the Consulate, seal off the lower levels, and fight his way up (<Link to="/comic-issues/Issue95">Issue #95</Link>).
          </p>
          <p>
