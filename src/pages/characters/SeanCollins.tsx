    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Sean's parents are Cobra agents. His father is a Crimson Guardsman named <Link to="/character-bios/FredBroca">Fred Broca</Link>, the original Fred in the Fred series of Crimson Guards. The Broca family purchases a home next to Fort Wadsworth on Staten Island. Sean, a preteen at the time, moves in with his family. Sean's parents set up Cobra surveillance equipment in their home (Issue #30). One day, Destro and <Link to="/character-bios/Firefly">Firefly</Link> arrive at the family's home and collect Sean's father for a mission of great importance (Issue #31).
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Sean Collins arrives at the Motor Pool with his new orders. Disappointed, he tells the Joes he's been assigned to an instructor cadre at a new training facility in Texas. They tell him <Link to="/character-bios/WildBill">Wild Bill</Link> is headed to that same base, and that <Link to="/character-bios/Clutch">Clutch</Link> will drive him to the C-130. Before Sean departs, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> gives him one of his personal Sykes-Fairbairn commando daggers — a gift that visibly moves him. <Link to="/character-bios/Clutch">Clutch</Link> jokes, "You must rate, Sean — I never got one of those." <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/CoverGirl">Cover Girl</Link>  kiss Sean's cheeks, prompting <Link to="/character-bios/Clutch">Clutch</Link> to add, in surprise, "I never got one of these either!"
          </p>
          <p>
