    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            A G.I. Joe team made up of <Link to="/character-bios/Stalker">Stalker</Link>, <Link to="/character-bios/Scarlett">Scarlett</Link>, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and <Link to="/character-bios/Breaker">Breaker</Link> first encounters Kwinn in the Arctic. General Flagg dispatches the team there in response to a commando-style raid on an American research station, during which all its records went missing.
          </p>
          <p>
            The team observes Kwinn stealing a frequency modulator from a Russian station. The Joes track him down, only to be captured themselves. Kwinn loads their weapons and gear onto his dog sled, and before departing, reveals that the Russians intend to use low-frequency fear waves against the U.S. to induce mass paranoia.
          </p>
          <p>
          ...
          <p>
            Kwinn delivers the equipment to the Russians, telling them he intends to be as far away as possible by the time the Joes arrive. The Russians insist he stay and protect them, but Kwinn tells them his contract is fulfilled and departs anyway. The Joes arrive shortly after — with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> now wearing Kwinn's necklace of weasel skulls (Issue #2).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Kwinn serves as a mercenary for Cobra in Sierra Gordo when a G.I. Joe team of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Stalker">Stalker</Link>, Gung-Ho, and <Link to="/character-bios/Breaker">Breaker</Link> is sent there. He is in the Cobra-controlled warehouse with <Link to="/character-bios/Venom">Dr. Venom</Link> and Cobra operatives when the Joes arrive, and it is Kwinn who captures them. The Joes are tied up, and <Link to="/character-bios/Stalker">Stalker</Link>, Gung-Ho, and <Link to="/character-bios/Breaker">Breaker</Link> are taken aboard a riverboat. Still bitter over being struck by <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Venom">Dr. Venom</Link> pistol-whips him to the point of appearing dead. Cobra troopers leave his bound body behind in the warehouse and set it ablaze.
          </p>
          <p>
            After the riverboat departs, <Link to="/character-bios/Venom">Dr. Venom</Link> reflects on his earlier encounter with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> in the laboratory and realizes he is only feigning death. The boat carries them to a small artificial island with a pier and a single bunker, guarded by vicious Dobermans. A seaplane is already waiting, carrying the <Link to="/character-bios/Baroness">Baroness</Link> and Scarface. Inside the bunker, the <Link to="/character-bios/Baroness">Baroness</Link>, Scarface, Kwinn, and <Link to="/character-bios/Venom">Dr. Venom</Link> meet, where <Link to="/character-bios/Venom">Dr. Venom</Link> presents the <Link to="/character-bios/Baroness">Baroness</Link> with a serum that took his lab in Sierra Gordo two years to produce.
          </p>
          <p>
            Outside, the three Joes free themselves, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> swims to the pier. Together, they defeat the Cobra troopers guarding the island. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> orders the others to escape aboard the riverboat while he deals with <Link to="/character-bios/Venom">Dr. Venom</Link> inside the bunker. Kwinn opens fire with his .50-cal, and the <Link to="/character-bios/Baroness">Baroness</Link> and Scarface flee to the seaplane with the serum in hand. As <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> attacks <Link to="/character-bios/Venom">Dr. Venom</Link>, the <Link to="/character-bios/Baroness">Baroness</Link> fires a missile at the island. Kwinn shoves both <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Venom">Dr. Venom</Link> into the bunker, saving their lives as the island sinks beneath the river (Issue #12).
          </p>
          <p>
        ...
        <section className="profile-notes">
          ...
          <p>
            Kwinn is a creation of Mr. Hama, and a showcase of his talent for crafting unique, memorable characters. No action figure of Kwinn was ever produced during the Marvel run (1982–1994). In the 2000s, however, two versions were finally released: a 2004 figure and a 2013 figure.
          </p>
        </section>
