    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            At Dr. Burkhart's home, <Link to="/character-bios/Jinx">Jinx</Link> informs the group that <Link to="/character-bios/Hawk">Hawk</Link> and Hollingsworth are being held at St. Lo's infirmary in rural Virginia. Shortly after, <Link to="/character-bios/CoverGirl">Cover Girl</Link>, Dusty, Bazooka, Barbecue, <Link to="/character-bios/Flash">Flash</Link>, Wet-Suit, Snow Job, <Link to="/character-bios/Steeler">Steeler</Link>, and <Link to="/character-bios/Zap">Zap</Link> arrive in a telephone truck. Dr. Burkhart and <Link to="/character-bios/Lola">Lola</Link> join the Joes on the hospital raid. Film crews are on scene as the Joes carry out their raid, and Destro arrives to present receipts from M.A.R.S. on camera, clearing the Joes of any wrongdoing (Issue #78).
          </p>
        </section>
