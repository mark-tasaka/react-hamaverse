    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Tyrone drives the <Link to="/character-bios/BlindMaster">Blind Master</Link> (<Link to="/character-bios/Zartan">Zartan</Link>) to the woods outside Denver, in front of the Rockies, where they find <Link to="/character-bios/Billy">Billy</Link> and Raptor preparing to exhume Cobra Commander's body. Disgusted, the <Link to="/character-bios/BlindMaster">Blind Master</Link> strikes Raptor and tells <Link to="/character-bios/Billy">Billy</Link> not to let this trash desecrate his father's grave, warning him about the endless cycle of vengeance. <Link to="/character-bios/Billy">Billy</Link> convinces the <Link to="/character-bios/BlindMaster">Blind Master</Link> that the true target of their revenge is the current Cobra Commander (<Link to="/comic-issues/Issue95">Issue #95</Link>).
          </p>
          <p>
