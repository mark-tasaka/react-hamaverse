    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            The next day, the three prisoners, Croc Master, the imposter <Link to="/character-bios/CobraCommander">Cobra Commander</Link> (Fred VII), <Link to="/character-bios/Firefly">Firefly</Link>, Voltar, and <Link to="/character-bios/Zartan">Zartan</Link> are arguing inside the landlocked freighter. <Link to="/character-bios/Billy">Billy</Link> accuses the current <Link to="/character-bios/CobraCommander">Cobra Commander</Link> of being Fred VII and suggests he may be responsible for the murder of the real <Link to="/character-bios/CobraCommander">Cobra Commander</Link>. Voltar demands proof, suggesting perhaps <Link to="/character-bios/Billy">Billy</Link> is the imposter. Tyrone, confused, wonders where the <Link to="/character-bios/BlindMaster">Blind Master</Link> is, and who is this <Link to="/character-bios/Zartan">Zartan</Link> character.
          </p>
          <p>
