    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Billy">Billy</Link> begins training with <Link to="/character-bios/Jinx">Jinx</Link> at the Denver dojo. Time passes. One day, while sparring with <Link to="/character-bios/Jinx">Jinx</Link>, the Blind Master shows him a photo taken fifteen years earlier. <Link to="/character-bios/Jinx">Jinx</Link> explains who's in it: the Blind Master, Professor Onihashi (a mystic swordsmith), an unnamed Koga ninja (his image blurred), <Link to="/character-bios/Jinx">Jinx</Link> herself (at age eight), Storm Shadow, the <Link to="/character-bios/HardMaster">Hard Master</Link>, the <Link to="/character-bios/SoftMaster">Soft Master</Link>, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. The Blind Master then reveals that <Link to="/character-bios/Jinx">Jinx</Link> is Storm Shadow's second cousin on his mother's side.
          </p>
          <p>
