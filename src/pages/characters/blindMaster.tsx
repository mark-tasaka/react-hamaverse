    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> arrive at the circus, and the six mount a rescue mission together. They kill the guards and free the prisoners, including the three Joes. As they head for the border, the <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky appear in a car hauling their circus cannon. The Joes are loaded into the cannon and fired into the river bordering Borovia, allowing them to safely bypass the electric fence, barbed wire, and guard towers along the border (Issue #66).
          </p>
        </section>
