    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-notes">
          ...
          <p>
            G.I. Joe: Declassified #1 reveals that Fred Broca underwent plastic surgery to match the faces of the others in the Fred series — raising the question of whose face the Freds were actually modeled after. In Issue #98, Cobra Commander's partially shown face, glimpsed as a Fred surgeon operates to remove a bullet, bears a striking resemblance to the Freds' own. Could the Freds' faces have been modeled on Cobra Commander's all along?
          </p>
        </section>
