    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Months later, Scarlett, Rock 'n Roll, and <Link to="/character-bios/Grunt">Grunt</Link> are on a mission in the Middle East, traveling in one of two helicopters. Neither aircraft has proper dust filters, and the helicopter carrying the four of them stalls and spins out of control after sand is sucked into the engine. The pilot orders the crew to jump. Rock 'n Roll and <Link to="/character-bios/Grunt">Grunt</Link> jump clear, but the door next to Scarlett slams shut, trapping her web gear. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> stays aboard, trying to save her. The helicopter crashes into the second one, knocking Scarlett unconscious.
          </p>
          <p>
