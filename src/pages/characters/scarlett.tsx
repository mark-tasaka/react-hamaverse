    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            During the sixth and final procedure, Scarlett receives a call from <Link to="/character-bios/Hawk">Hawk</Link> at the hospital. <Link to="/character-bios/Hawk">Hawk</Link> tells her that Zarana, who works for Cobra, has just awoken from a coma and has been rambling about a plot between the Baroness and <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>. Scarlett drops the phone as a Cobra transport helicopter lands on the hospital's roof.
          </p>
          <p>
            Scarlett pulls her Uzi from her purse, enters the surgery room, and ties up <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> and the nurses. She puts the unconscious <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> in a wheelchair and heads for the exit, but in the hallway, the Baroness and her Vipers catch up to her, and a gunfight breaks out.
          </p>
          <p>
            Scarlett pushes <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' wheelchair into a room while she returns fire, then moves inside herself. A round hits her in the upper arm as a group of Alley Vipers crash through the windows. The Baroness enters and kicks the Uzi out of Scarlett's hand. When one of the Vipers asks if they should finish her off, the Baroness says no — she wants to do it herself — and shoots Scarlett point-blank in the head (<Link to="/comic-issues/Issue94">Issue #94</Link>). Scarlett does not die from the shot; the bullet strikes the dome of her skull at an oblique angle, deflecting off and leaving her in a coma instead (<Link to="/comic-issues/Issue95">Issue #95</Link>).
          </p>
        </section>
