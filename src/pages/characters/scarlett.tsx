    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            During the sixth and final procedure, Scarlett receives a call from <Link to="/character-bios/Hawk">Hawk</Link> at the hospital. <Link to="/character-bios/Hawk">Hawk</Link> tells her that Zarana, who works for Cobra, has just awoken from a coma and has been rambling about a plot between the Baroness and Dr. Hundtkinder. Scarlett drops the phone as a Cobra transport helicopter lands on the hospital's roof.
          </p>
          <p>
