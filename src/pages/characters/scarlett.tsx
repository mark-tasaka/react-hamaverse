    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Hawk tells Scarlett that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is in Borovia. Scarlett is shocked, pointing out that the Borovian government is in the midst of collapse, the country is in anarchy, and there are rumors of wholesale slaughter of ethnic minorities. General Thurston Crowther enters and reveals that <Link to="/character-bios/StormShadow">Storm Shadow</Link> had blackmailed him into sending <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> on the mission (Issue #105).
          </p>
          <p>
