    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, Flint, and <Link to="/character-bios/LadyJay">Lady Jay</Link> are on vacation in Grenada. While walking down a dirt road, the four run into <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' old friend, the <Link to="/character-bios/BlindMaster">Blind Master</Link>, disguised as a blind man on his way to visit his daughter. The blind man asks for help guiding him to the airport, so he won't be late. He insists on taking a shortcut through a field of tall grass. Scarlett and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> take the blind man through the field; Flint and <Link to="/character-bios/LadyJay">Lady Jay</Link> continue down the road.
          </p>
          <p>
