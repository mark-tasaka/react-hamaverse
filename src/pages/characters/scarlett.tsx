...
const Scarlett: React.FC = () => {
 ...
 <section className="profile-block">
        ...
        <p>
            On the ground, Scarlett and <Link to="/character-bios/Stalker">Stalker</Link> meet up with <Link to="/character-bios/StormShadow">Storm Shadow</Link> and Wade Collins, who are locked in a firefight with Vipers. The W.H.A.L.E. hovercraft arrives, forcing the Vipers to retreat, and Scarlett, <Link to="/character-bios/Stalker">Stalker</Link>, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and Wade board it. The W.H.A.L.E. heads for the Cobra lab.
        </p>
        <p>
