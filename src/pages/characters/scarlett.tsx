    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> first travel to France (Issue #64). From there, they make their way to Borovia, where they find work in the <Link to="/character-bios/WhiteClown">White Clown</Link>'s circus troupe (Issue #65). The <Link to="/character-bios/WhiteClown">White Clown</Link> is assisted by Orlovsky the dwarf. The trio learns that the <Link to="/character-bios/WhiteClown">White Clown</Link>'s lover, Magda, is imprisoned in a gulag for criticizing the government — a different gulag from the one holding the three captured Joes.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> arrive at the circus, and the six mount a rescue mission together. They kill the guards and free the prisoners, including the three Joes. As they head for the border, the <Link to="/character-bios/WhiteClown">White Clown</Link> and Orlovsky appear in a car hauling their circus cannon. The Joes are loaded into the cannon and fired into the river bordering Borovia, allowing them to safely bypass the barbed wire fence, and guard towers along the border (Issue #66).
          </p>
        </section>
