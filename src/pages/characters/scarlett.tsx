...
const Scarlett: React.FC = () => {
    ...
    <main className="character-profile-page">
      <div className="container">
        ...
        <section className="profile-block">
          ...
          <p>
            When the G.I. Joe team was forming, Scarlett ran a hand-to-hand combat session to teach the Joes how to fight. She first spars with <Link to="/character-bios/Steeler">Steeler</Link>, easily throwing him to the ground, but knows she still needs to prove to the guys that this was no fluke. Her next opponent is <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, who allows Scarlett to throw him to spare her pride in front of the others. Scarlett recognizes he is a highly skilled martial artist, who allowed her to win. Scarlett is intrigued with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and wants to know more about him.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Months later, Scarlett, <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>, and <Link to="/character-bios/Grunt">Grunt</Link> are on a mission in the Middle East, traveling in one of two helicopters. Neither aircraft has proper dust filters, and the helicopter carrying the four of them stalls and spins out of control after sand is sucked into the engine. The pilot orders the crew to jump. <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> and <Link to="/character-bios/Grunt">Grunt</Link> jump clear, but the door next to Scarlett slams shut, trapping her web gear. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> stays aboard, trying to save her. The helicopter crashes into the second one, knocking Scarlett unconscious.
          </p>
          <p>
        ...
        <section className="profile-block">
          ...
          <p>
            Scarlett comes across two Cobra troopers carrying a C.L.A.W. (likely the one <Link to="/character-bios/StormShadow">Storm Shadow</Link> had used) and knocks them unconscious using the chain as a weapon. She straps on the C.L.A.W. and flies off. From one of the castle's balconies, she spots <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. <Link to="/character-bios/StormShadow">Storm Shadow</Link> then reappears, and the two engage in combat. During the fight, the wrapping on one of <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s forearms unravels, revealing the same tattoo <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> bears on his own forearm.
          </p>
          <p>
            Scarlett lands the C.L.A.W. in front of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. <Link to="/character-bios/StormShadow">Storm Shadow</Link> hurls his sword toward her, but <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, appearing from behind, catches the blade in midair. The two then fly off together, escaping the Silent Castle (<Link to="/comic-issues/Issue21">Issue #21</Link>).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Flint">Flint</Link>, and <Link to="/character-bios/LadyJay">Lady Jaye</Link> are on vacation in Grenada. While walking down a dirt road, the four run into <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' old friend, the <Link to="/character-bios/BlindMaster">Blind Master</Link>, disguised as a blind man on his way to visit his daughter. The blind man asks for help guiding him to the airport, so he won't be late. He insists on taking a shortcut through a field of tall grass. Scarlett and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> take the blind man through the field; <Link to="/character-bios/Flint">Flint</Link> and <Link to="/character-bios/LadyJay">Lady Jaye</Link> continue down the road.
          </p>
          <p>
            The field turns out to be a minefield. A powerful explosion goes off, making it appear that Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the blind man have been killed. The blast is so large that <Link to="/character-bios/Flint">Flint</Link>, at first, believes they were vaporized by it. In reality, the <Link to="/character-bios/BlindMaster">Blind Master</Link> has orchestrated the whole thing so that Scarlett and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> can fake their deaths and slip away on an unauthorized mission to rescue the three captured Joes in Borovia (Issue #63).
          </p>
          <p>
            Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the <Link to="/character-bios/BlindMaster">Blind Master</Link> first travel to France (Issue #64). From there, they make their way to Borovia, where they find work in the <Link to="/character-bios/WhiteClown">White Clown</Link>'s circus troupe (Issue #65). The <Link to="/character-bios/WhiteClown">White Clown</Link> is assisted by <Link to="/character-bios/Orlovsky">Orlovsky</Link> the dwarf. The trio learns that the <Link to="/character-bios/WhiteClown">White Clown</Link>'s lover, <Link to="/character-bios/Magda">Madga</Link>, is imprisoned in a gulag for criticizing the government — a different gulag from the one holding the three captured Joes.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link>, <Link to="/character-bios/Jinx">Jinx</Link>, and <Link to="/character-bios/Billy">Billy</Link> arrive at the circus, and the six mount a rescue mission together. They kill the guards and free the prisoners, including the three Joes. As they head for the border, the <Link to="/character-bios/WhiteClown">White Clown</Link> and <Link to="/character-bios/Orlovsky">Orlovsky</Link> appear in a car hauling their circus cannon. The Joes are loaded into the cannon and fired into the river bordering Borovia, allowing them to safely bypass the barbed wire fence, and guard towers along the border (Issue #66).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            Scarlett and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> travel to the Bern Institute of Reconstructive Surgery in Switzerland, where <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> has developed a new technique in facial reconstructive surgery. Outside the hospital, Scarlett tells <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> the new technique is dangerous, possibly even fatal, and that he doesn't need to go through with it for her sake — she loves him just the way he is.
          </p>
          <p>
          ...
          <p>
            Scarlett accompanies <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> as <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> examines his face. When <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> explains that the first procedure will take place the next morning, she hugs <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> (<Link to="/comic-issues/Issue93">Issue #93</Link>).
          </p>
          <p>
            During the sixth and final procedure, Scarlett receives a call from <Link to="/character-bios/Hawk">Hawk</Link> at the hospital. <Link to="/character-bios/Hawk">Hawk</Link> tells her that <Link to="/character-bios/Zarana">Zarana</Link>, who works for Cobra, has just awoken from a coma and has been rambling about a plot between the <Link to="/character-bios/Baroness">Baroness</Link> and <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>. Scarlett drops the phone as a Cobra transport helicopter lands on the hospital's roof.
          </p>
          <p>
            Scarlett pulls her Uzi from her purse, enters the surgery room, and ties up <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link> and the nurses. She puts the unconscious <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> in a wheelchair and heads for the exit, but in the hallway, the <Link to="/character-bios/Baroness">Baroness</Link> and her Vipers catch up to her, and a gunfight breaks out.
          </p>
          <p>
            Scarlett pushes <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' wheelchair into a room while she returns fire, then moves inside herself. A round hits her in the upper arm as a group of Alley Vipers crash through the windows. The <Link to="/character-bios/Baroness">Baroness</Link> enters and kicks the Uzi out of Scarlett's hand. When one of the Vipers asks if they should finish her off, the <Link to="/character-bios/Baroness">Baroness</Link> says no — she wants to do it herself — and shoots Scarlett point-blank in the head (<Link to="/comic-issues/Issue94">Issue #94</Link>). Scarlett does not die from the shot; the bullet strikes the dome of her skull at an oblique angle, deflecting off and leaving her in a coma instead (<Link to="/comic-issues/Issue95">Issue #95</Link>).
          </p>
        </section>
        ...
        <section className="profile-block">
          ...
          <p>
            <Link to="/character-bios/Sioban">Sioban</Link> and Scarlett talk, and Scarlett realizes the push to end her life support has much to do with the family house in Atlanta. She tells <Link to="/character-bios/Sioban">Sioban</Link> that if the house means that much to her, she'll sign it over to her. In tears, <Link to="/character-bios/Sioban">Sioban</Link> leaves the room just as <Link to="/character-bios/Hawk">Hawk</Link> arrives (Issue #104).
          </p>
          <p>
            <Link to="/character-bios/Hawk">Hawk</Link> tells Scarlett that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is in Borovia. Scarlett is shocked, pointing out that the Borovian government is in the midst of collapse, the country is in anarchy, and there are rumors of wholesale slaughter of ethnic minorities. General Thurston Crowther enters and reveals that <Link to="/character-bios/StormShadow">Storm Shadow</Link> had blackmailed him into sending <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> on the mission (Issue #105).
          </p>
          <p>
            An undisclosed amount of time passes. General Crowther visits Scarlett in her room, telling her that <Link to="/character-bios/StormShadow">Storm Shadow</Link> and <Link to="/character-bios/Stalker">Stalker</Link> have escaped capture. He believes they are hiding at <Link to="/character-bios/StormShadow">Storm Shadow</Link>'s secret hideout in New York and that Scarlett knows where it is. She refuses to answer, insisting it's up to her to find <Link to="/character-bios/StormShadow">Storm Shadow</Link> herself.
          </p>
          <p>
            <Link to="/character-bios/Hawk">Hawk</Link> enters and tells Scarlett she isn't going anywhere — he has already notified the hospital to keep her detained. He leaves the room with General Crowther just as <Link to="/character-bios/Sioban">Sioban</Link> enters. Outside, <Link to="/character-bios/Hawk">Hawk</Link> confronts the General, demanding to know why he's badgering Scarlett, why he ordered the arrest of <Link to="/character-bios/StormShadow">Storm Shadow</Link> and <Link to="/character-bios/Stalker">Stalker</Link>, where they are now, and what <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' real mission in Borovia was. While the two argue, Scarlett slips past them disguised as <Link to="/character-bios/Sioban">Sioban</Link>, having tied her sister up and taken her clothes.
          </p>
          <p>
            Scarlett gets off at a subway stop, where a would-be mugger confronts her with a knife. She disarms him, breaks his elbow, and walks off with his knife. Later, she runs into <Link to="/character-bios/StormShadow">Storm Shadow</Link> fleeing from Night Creepers. She confronts him just as the Night Creepers open fire with arrows, and <Link to="/character-bios/StormShadow">Storm Shadow</Link> pushes the two of them onto the tracks in front of an oncoming subway train to escape.
          </p>
          <p>
            <Link to="/character-bios/StormShadow">Storm Shadow</Link> pulls them both to safety between the train cars. In the chaos, Scarlett accidentally stabs him in the back. Shocked, she cries out, "What have I done?" (Issue #107).
          </p>
          <p>
            Scarlett brings the wounded <Link to="/character-bios/StormShadow">Storm Shadow</Link> to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' secret hideout behind the isolation tank at Columbia University. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Stalker">Stalker</Link> arrive shortly after. Scarlett watches as <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> uses the Arashikage Mindset to stabilize him, then calls for an ambulance (Issue #108).
          </p>
        </section>
 ...
 <section className="profile-block">
          ...
          <p>
            A month after G.I. Joe is disbanded, Scarlett, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, <Link to="/character-bios/Hawk">Hawk</Link>, and a select team of Joes go on one last mission (Frontline Issue #1). Afterward, Scarlett and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> retire to their cabin in the High Sierras.
          </p>
          <p>
        ...
        <p>
            On the ground, Scarlett and <Link to="/character-bios/Stalker">Stalker</Link> meet up with <Link to="/character-bios/StormShadow">Storm Shadow</Link> and <Link to="/character-bios/Wade">Wade Collins</Link>, who are locked in a firefight with Vipers. The W.H.A.L.E. hovercraft arrives, forcing the Vipers to retreat, and Scarlett, <Link to="/character-bios/Stalker">Stalker</Link>, <Link to="/character-bios/StormShadow">Storm Shadow</Link>, and Wade board it. The W.H.A.L.E. heads for the Cobra lab.
        </p>
        <p>
        ...
        <section className="profile-notes">
          ...
          <p>
            Both Scarlett's original file card and her Ninja Force file card list her rank as E-5 (Sergeant or Specialist 5*). When Scarlett is wearing her dress uniform in the early issues (Issues #2 and #22), no sergeant stripes appear. Thus, I suspect she was a Spec. 5 in the early issues. In Issue #33, <Link to="/character-bios/Austin">General Austin</Link> promotes Scarlett — along with <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>, <Link to="/character-bios/Breaker">Breaker</Link>, <Link to="/character-bios/Zap">Zap</Link>, <Link to="/character-bios/Grunt">Grunt</Link>, Short-Fuze, <Link to="/character-bios/Stalker">Stalker</Link>, and <Link to="/character-bios/Flash">Flash</Link> — to the next pay grade, assigning them administrative duties as the team grows. This puts Scarlett's current rank at E-6 (Staff Sergeant).
          </p>
