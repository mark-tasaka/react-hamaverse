    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                Mr. Hama's classic issue with no dialogue. The story is told through the illustrations and layout. <Link to="/character-bios/Scarlett">Scarlett</Link> is captured and delivered to the Silent Castle by Storm Shadow. <Link to="/character-bios/Scarlett">Scarlett</Link> escapes her cell and commandeers a Cobra C.L.A.W. (Covert Light Aerial Weapon). <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Storm Shadow battle. <Link to="/character-bios/Scarlett">Scarlett</Link> finds <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, and the two depart. The issue ends by revealing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Storm Shadow share the same tattoo.
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            Once Destro and the troopers depart, the wounded sentry is revealed to be <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. Storm Shadow summons three Red Ninja underlings. <Link to="/character-bios/Scarlett">Scarlett</Link> approaches two Cobra troopers carrying the C.L.A.W. from behind and knocks the troopers out with her chains. She straps the C.L.A.W. on her back and flies down the hallway.
          </p>
          <p>
            <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> arrives at the open manhole cover looking for <Link to="/character-bios/Scarlett">Scarlett</Link>. A Red Ninja attacks. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> defeats the ninja. Another Red Ninja appears in an open doorway wielding a pair of Sai. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> throws a grenade, killing the ninja and causing an explosion. Storm Shadow and the remaining Red Ninja ambush <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> when he reaches the next room. The Red Ninja attacks with a kusarigama (chain and sickle weapon). <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> catches the counterweight at the end of the chain and wraps the ninja up with his own chain. He then uses the ninja to block Storm Shadow's attack. Storm Shadow kills the remaining ninja. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> jumps on Storm Shadow's head and flees the room towards the parapets.
          </p>
          <p>
            There he finds <Link to="/character-bios/Scarlett">Scarlett</Link> flying with the C.L.A.W. <Link to="/character-bios/Scarlett">Scarlett</Link> lands in front of <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. Storm Shadow appears. Storm Shadow throws his sword at <Link to="/character-bios/Scarlett">Scarlett</Link>. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> catches the blade and throws it away. <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> fly away. The issue ends by revealing <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Storm Shadow share the same tattoo on their forearms (<Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' uniform is torn on the sleeve; Storm Shadow's forearm wrap has come undone).
          </p>
        </section>
