    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            The Cobra Consulate in New York City is burning. In the previous issue, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> sealed the lower levels with explosives and is making his way to the penthouse to confront the <Link to="/character-bios/Baroness">Baroness</Link>.
          </p>
          <p>
            <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> tactically withdraws while engaged with a Viper combat patrol. The Vipers believe they have him cornered. From the safety of the penthouse command center, the <Link to="/character-bios/Baroness">Baroness</Link> reiterates that they — not <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> — are the ones who are trapped. Just then, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> appears, catching the Vipers by surprise. The Vipers are defeated while the <Link to="/character-bios/Baroness">Baroness</Link> watches the events play out on the video monitor.
          </p>
          <p>
          ...
          <p>
            Back in the penthouse, the Viper search parties are returning. The Tele-Viper reports to the <Link to="/character-bios/Baroness">Baroness</Link> that all but three members of the search party have returned. Destro appears on the monitor, wanting to know why smoke is rising from the Consulate (he is in a helicopter over New Jersey). The <Link to="/character-bios/Baroness">Baroness</Link> tells him the building has been bombed and they need an airlift. Destro turns his helicopter back toward the Consulate.
          </p>
          <p>
            The <Link to="/character-bios/Baroness">Baroness</Link> has the Vipers pile office furniture against the main door, forming a makeshift barricade. A suspicious-looking Techno-Viper, wrapped in a blanket, stands in the corner.
          </p>
          <p>
          ...
          <p>
            The penthouse floor gives way, throwing the remaining Vipers to their deaths. The <Link to="/character-bios/Baroness">Baroness</Link> clings to a crumbling section of floor, hanging outside the building. Her grip slips, but <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> catches her wrist, preventing her from falling. With her free hand, the <Link to="/character-bios/Baroness">Baroness</Link> draws her pistol and says she will not be robbed of her revenge. Destro's helicopter arrives, and he tells her that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> did not kill her brother.
          </p>
          <p>
          ...
          <p>
            Overwhelmed with guilt, the <Link to="/character-bios/Baroness">Baroness</Link> strikes <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' grip with her pistol, breaking free, and falls. <Link to="/character-bios/StormShadow">Storm Shadow</Link>, holding a rope with one hand, rappels down and catches her. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> pulls <Link to="/character-bios/StormShadow">Storm Shadow</Link> and the <Link to="/character-bios/Baroness">Baroness</Link> back up, then helps her board Destro's helicopter. As Destro reaches out to help <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, the girder beneath them gives way, sending <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/StormShadow">Storm Shadow</Link> falling. Fortunately, the Tomahawk is nearby — Lift Ticket flies it in below them and executes a barrel-roll maneuver, catching them both.
          </p>
          <p>
            From the other Cobra helicopter, Destro and the <Link to="/character-bios/Baroness">Baroness</Link> wave. <Link to="/character-bios/StormShadow">Storm Shadow</Link> waves back and asks, "Can the cycle of revenge be broken?" The two helicopters then depart in different directions.
          </p>
        </section>
