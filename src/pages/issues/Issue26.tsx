    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            <Link to="/character-bios/Zartan">Zartan</Link>, Destro, Cobra Commander, and the <Link to="/character-bios/Baroness">Baroness</Link> are inside <Link to="/character-bios/Zartan">Zartan</Link>'s cabin with Junkyard (Mutt's dog). Junkyard takes a liking to the Cobras. In the distance, Torpedo, Mutt, and Tripwire are watching the cabin. Mutt is upset that Junkyard has taken a liking to the Cobras. The Cobras and Junkyard leave the cabin. The Joes fall back so as not to be spotted. While falling back, the Joes spot <Link to="/character-bios/Firefly">Firefly</Link> and Wild Weasel, who were previously their prisoners, in the distance. <Link to="/character-bios/Firefly">Firefly</Link> and Wild Weasel spot the Joes. Junkyard leads <Link to="/character-bios/Zartan">Zartan</Link>, Destro, Cobra Commander, and the <Link to="/character-bios/Baroness">Baroness</Link> to a pit of quicksand. Junkyard then departs to rejoin his handler, Mutt.
          </p>
        </section>
