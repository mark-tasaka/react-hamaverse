        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                This issue explores <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' backstory, by examining his connection to Storm Shadow through their shared tattoos. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' past is told through <Link to="/character-bios/Stalker">Stalker</Link> (Vietnam War), Hawk (returning home from the war), and the <Link to="/character-bios/SoftMaster">Soft Master</Link> (<Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' training as a ninja in Japan).
              </p>
            </section>
          </div>
        </div>
