    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                This issue explores <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' backstory, by examining his connection to Storm Shadow through their shared tattoos. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' past is told through Stalker (Vietnam War), Hawk (returning home from the war), and the <Link to="/character-bios/SoftMaster">Soft Master</Link> (<Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' training as a ninja in Japan).
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            In the Pit, Hawk talks about his first encounter with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. While on their way to the airport, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' family was killed in a car accident by a stoned-out veteran driving erratically at high speed. Hawk, then a junior officer working at a desk, was dispatched to give <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> the tragic news. When Hawk arrived, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> had been waiting at the airport for four hours. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> knew from Hawk's uniform and the look on his face that something horrible had happened to his family.
          </p>
          <p>
            Back at the restaurant, the old man produces a broken arrow and talks about <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' time in Japan. Following the death of his family, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> traveled to Japan, taking his friend up on his offer to join the family business. The business turned out to be a ninja clan. The old man reveals himself to be the <Link to="/character-bios/SoftMaster">Soft Master</Link>. In charge of the clan is his older brother, the Hard Master. The <Link to="/character-bios/SoftMaster">Soft Master</Link>'s nephew is <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' friend Tommy, who is known as the Young Master. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> begins his training as a ninja. The <Link to="/character-bios/SoftMaster">Soft Master</Link> recalls an event that took place two years later. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and Tommy were sparring. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> was the superior fighter. He allowed Tommy to win to save face.
          </p>
          <p>
            Years pass, and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> earns the right to have the Arashikage tattoo. The <Link to="/character-bios/SoftMaster">Soft Master</Link> says that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' skill with the blade and throwing dirt surpasses Tommy's; Tommy's skill with the bow is superior, as he possesses the "Ear that Sees." While practicing archery, Tommy displayed this skill by firing an arrow over the wall, killing a squirrel on the other side. Later that day, inside the dojo, the Hard Master showed <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> the technique of the "Blind Sword." <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> then heard a third person outside in the courtyard. The Hard Master dismissed this, saying the person posed no danger. The Hard Master expressed his desire that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> be heir to the clan. <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> does not want this. The Hard Master goes behind a screen to demonstrate the "Chameleon's Mantle," mimicking <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' breathing and heartbeat. An arrow is fired from outside, killing the Hard Master.
          </p>
          <p>
            Hearing the commotion, the <Link to="/character-bios/SoftMaster">Soft Master</Link> ran out of his room to the dojo. In the courtyard, he saw the Young Master (Tommy) run away with a bow in hand. Upon entering the dojo and seeing the dying Hard Master, the <Link to="/character-bios/SoftMaster">Soft Master</Link> believed only the Young Master had the skill and strength to make the shot. With his last breath, the Hard Master said his nephew was not responsible.
          </p>
        </section>
