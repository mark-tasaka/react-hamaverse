    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                There are two story arcs in this issue. The main arc follows <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> as he escapes the dungeon below the Cobra Consulate and fights his way up through the building to confront the Baroness. The secondary arc follows <Link to="/character-bios/Billy">Billy</Link> and Raptor's exhumation of Cobra Commander's grave.
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> dons the outfits of the dead Paine Brothers and collects their weapons. Meanwhile, in the penthouse command center, a Tele-Viper discreetly shows the Baroness the feed from the subbasement. She whispers an order to dispatch a team of Vipers to recapture him.
          </p>
          <p>
            A team of Night Vipers enters the basement and is swiftly dispatched by <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>.
          </p>
          <p>
            The main floor of the Consulate falls into chaos as Vipers scramble to seal off every potential exit from the lower levels. A Siegie (Crimson Guardsman) asks the Tele-Viper receptionist about his appointment with the Baroness; he's told she isn't seeing anyone today, and leaves the building.
          </p>
          <p>
          ...
          <p>
            On the roof, the Baroness and her Tele-Viper see Destro off as he boards his helicopter. Destro warns her that if she cannot secure the release of Zarana and the Dreadnoks from Joe custody within a week, he will act himself. As his helicopter departs, the Baroness orders the Tele-Viper to mobilize everyone — she wants <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> dead.
          </p>
          <p>
          ...
          <p>
            More explosions rip through the floors above. <Link to="/character-bios/Stalker">Stalker</Link> realizes <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> deliberately emptied the Consulate before sealing off the lower levels. <Link to="/character-bios/StormShadow">Storm Shadow</Link> remarks that he's now working his way up to deal with the Baroness.
          </p>
          <p>
            In the penthouse, the Tele-Viper informs the Baroness that <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> is six floors below. She grows visibly nervous as she continues speaking with Destro on the large monitor.
          </p>
        </section>
