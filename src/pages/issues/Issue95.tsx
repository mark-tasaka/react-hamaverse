    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                There are two story arcs in this issue. The main arc follows <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> as he escapes the dungeon below the Cobra Consulate and fights his way up through the building to confront the <Link to="/character-bios/Baroness">Baroness</Link>. The secondary arc follows <Link to="/character-bios/Billy">Billy</Link> and <Link to="/character-bios/Raptor">Raptor</Link>'s exhumation of <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s grave.
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            On the roof, the <Link to="/character-bios/Baroness">Baroness</Link> and her Tele-Viper see Destro off as he boards his helicopter. Destro warns her that if she cannot secure the release of <Link to="/character-bios/Zarana">Zarana</Link> and the Dreadnoks from Joe custody within a week, he will act himself. As his helicopter departs, the <Link to="/character-bios/Baroness">Baroness</Link> orders the Tele-Viper to mobilize everyone — she wants <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> dead.
          </p>
          <p>
        ...
        <section className="issue-section">
          ...
          <p>
            <Link to="/character-bios/Billy">Billy</Link> and <Link to="/character-bios/Raptor">Raptor</Link> are about to begin exhuming <Link to="/character-bios/CobraCommander">Cobra Commander</Link>'s remains when a red car pulls up. <Link to="/character-bios/Tyrone">Tyrone</Link> and the <Link to="/character-bios/BlindMaster">Blind Master</Link> (secretly <Link to="/character-bios/Zartan">Zartan</Link> in disguise) step out. The <Link to="/character-bios/BlindMaster">Blind Master</Link> strikes <Link to="/character-bios/Raptor">Raptor</Link>, calling him trash for desecrating <Link to="/character-bios/Billy">Billy</Link>'s father's grave, and warns <Link to="/character-bios/Billy">Billy</Link> about the endless cycle of vengeance. <Link to="/character-bios/Billy">Billy</Link> replies that the target of his revenge is the current <Link to="/character-bios/CobraCommander">Cobra Commander</Link> — and that killing him would do the world a favor.
          </p>
        </section>
