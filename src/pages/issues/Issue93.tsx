    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            On Long Island, the Joes catch up to the Dreadnoks, and a firefight breaks out. The Joes come out on top, lining the Dreadnoks up against a wall and freeing <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>. A crowd of angry onlookers gathers around the scene — one shoves <Link to="/character-bios/LadyJay">Lady Jay</Link>, while others accuse the Joes of military brutality, invoking comparisons to Kent State and the Tiananmen Square massacre. The distraction gives the Dreadnoks a chance to escape in their ice cream truck. Roadblock fires his .50-cal into the air to disperse the crowd, and the Joes take off in pursuit.
          </p>
          <p>
