    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            At the Cobra Consulate, the Baroness receives a call from <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>, who had performed her own reconstructive surgery years earlier. He tells her his latest client's surgery was paid for by the Chaplain's Assistant Training School at Fort Wadsworth and faxes her a photo of the client taken nearly twenty years prior. The Baroness recognizes the face immediately — it belongs to the man who murdered her brother in Saigon two decades before.
          </p>
          <p>
