    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                The <Link to="/character-bios/Baroness">Baroness</Link> and the Dreadnoks must deliver the captured <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> back to the G.I. Joes, having turned them into unwitting Cobra agents through use of the Brainwave Scanner. Meanwhile, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and <Link to="/character-bios/Scarlett">Scarlett</Link> are in Switzerland for <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' upcoming reconstructive facial surgery at the Bern Institute of Reconstructive Surgery, scheduled for the following morning. <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> are returned to the Joes, and the surgeon who will operate on <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> unknowingly informs the <Link to="/character-bios/Baroness">Baroness</Link> of his surgery.
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            The issue opens with the <Link to="/character-bios/Baroness">Baroness</Link>, the Dreadnoks, and a bound <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link> aboard a Cobra transport helicopter enroute to the Cobra Consulate in New York. The <Link to="/character-bios/Baroness">Baroness</Link> and <Link to="/character-bios/Zarana">Zarana</Link> are fighting throughout the flight. When the helicopter lands on the Consulate's roof, the two continue their fight on the platform, where Destro is waiting. Destro tells them to set aside their differences, since they will share joint control of the Consulate in his absence — he is departing to handle matters in New York and Broca Beach.
          </p>
          <p>
            Inside the Consulate, the <Link to="/character-bios/Baroness">Baroness</Link> and the Dreadnoks continue their work with the Brainwave Scanner, implanting false memories in <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>. The Dreadnoks then depart with the two captives in civilian vehicles — an ice cream truck and a van — intending to deliver their brainwashed prisoners to the Joes. The <Link to="/character-bios/Baroness">Baroness</Link> places a call to the Joes, tipping them off about the vehicles carrying <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>.
          </p>
          <p>
          ...
          <p>
            On Long Island, the Joes catch up to the Dreadnoks, and a firefight breaks out. The Joes come out on top, lining the Dreadnoks up against a wall and freeing <Link to="/character-bios/Clutch">Clutch</Link> and <Link to="/character-bios/RockRoll">Rock 'n Roll</Link>. A crowd of angry onlookers gathers around the scene — one shoves <Link to="/character-bios/LadyJay">Lady Jaye</Link>, while others accuse the Joes of military brutality, invoking comparisons to Kent State and the Tiananmen Square massacre. The distraction gives the Dreadnoks a chance to escape in their ice cream truck. Roadblock fires his .50-cal into the air to disperse the crowd, and the Joes take off in pursuit.
          </p>
          <p>
          ...
          <p>
            Back on Long Island, the Dreadnoks are speeding away in the ice cream truck when <Link to="/character-bios/Zarana">Zarana</Link> calls the <Link to="/character-bios/Baroness">Baroness</Link>, demanding to know why she was set up. The <Link to="/character-bios/Baroness">Baroness</Link> replies that she needed their release to look credible — <Link to="/character-bios/Zarana">Zarana</Link> and the Dreadnoks were meant to put up a fight and lose. She says she has a contingency plan and presses a red button. The ice cream truck's engine explodes.
          </p>
        </section>
