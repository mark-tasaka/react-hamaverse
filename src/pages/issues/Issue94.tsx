    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <div className="issue-header">
          ...
          <div className="issue-header-info">
            ...
            <section className="issue-section">
              ...
              <p>
                <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> undergoes his sixth and final procedure. While under, he relives memories of Saigon during the Tet Offensive. The Baroness arrives, and it is revealed that she and her older brother were in Saigon during the Tet Offensive. The young Baroness and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' paths crossed in Saigon; she falsely blames him for the death of her brother.
              </p>
            </section>
          </div>
        </div>
        ...
        <section className="issue-section">
          ...
          <p>
            Back at the Bern Institute, <Link to="/character-bios/Scarlett">Scarlett</Link> receives a call from <Link to="/character-bios/Hawk">Hawk</Link>, who fills her in on the recovery of <Link to="/character-bios/Clutch">Clutch</Link> and Rock 'n Roll, the capture of the Dreadnoks, and the explosion that knocked Zarana and Road Pig unconscious. <Link to="/character-bios/Hawk">Hawk</Link> tells her that when Zarana came to, she was raving about the Baroness and a plot involving <Link to="/character-bios/Hundtkinder">Dr. Hundtkinder</Link>. Just then, <Link to="/character-bios/Scarlett">Scarlett</Link> drops the phone as the Baroness' helicopters land on the roof. She breaks into the operating room, ties up the doctor and nurses, and flees with an unconscious <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> in a wheelchair.
          </p>
          <p>
            As the Baroness makes her way down the stairwell with her Vipers, she recalls events from twenty years earlier in Saigon. At fifteen, she had traveled there with her brother, Baron Eugene DeCobray, a humanitarian on a mission to check on a shipment of medical supplies. The two arrive at the warehouse where the supplies were meant to have been delivered, only to find it empty. Two Vietnamese men enter — the same two who attacked <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. Eugene asks the Baroness to wait in the office while he speaks with them. It is the last time she ever sees him alive.
          </p>
          <p>
            The issue returns to <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>' memories from Saigon. He is standing on the ledge outside the window where Eugene is meeting with the two Vietnamese men. Eugene demands to know where the medical supplies went. One of the men, Tran, says they were sold on the black market to buy guns and explosives. Eugene is outraged, having solicited the funds in the name of world peace. Tran raises his AK-47 and opens fire on Eugene. Just then, <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> jumps through the window, firing his .45 and killing the two Vietnamese men.
          </p>
          <p>
            The fifteen-year-old Baroness hears the noise and opens the office door to see <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> standing over the dead bodies of her brother and the two Vietnamese men. She looks up at <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and says, "You murdered him!"
          </p>
          <p>
            The issue returns to the present. The Baroness and her Vipers are running down the hall when they reach <Link to="/character-bios/Scarlett">Scarlett</Link> and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. <Link to="/character-bios/Scarlett">Scarlett</Link> wheels <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> into a room and returns fire, shooting out the lights. <Link to="/character-bios/Scarlett">Scarlett</Link> ducks inside the room with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> and reloads her clip. On the ledge outside the windows, a group of Alley Vipers gather. <Link to="/character-bios/Scarlett">Scarlett</Link> returns fire from the room.
          </p>
          <p>
            The Alley Vipers break through the window as a round grazes <Link to="/character-bios/Scarlett">Scarlett</Link>'s upper arm. <Link to="/character-bios/Scarlett">Scarlett</Link> falls to the ground. The Baroness enters as one of the Alley Vipers asks if he should finish her off. The Baroness kicks the Uzi out of <Link to="/character-bios/Scarlett">Scarlett</Link>'s reach. <Link to="/character-bios/Scarlett">Scarlett</Link> tells the Baroness she will get nothing from her. The Baroness replies that she did not order the Alley Viper to kill her, as she wanted to do it herself. The Baroness raises her pistol and fires point-blank into <Link to="/character-bios/Scarlett">Scarlett</Link>'s head. She then turns to the unconscious <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>, saying she will take him to New York, where he'll have plenty of time to make up for what he did to her brother.
          </p>
        </section>
