    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            As the Baroness makes her way down the stairwell with her Vipers, she recalls events from twenty years earlier in Saigon. At fifteen, she had traveled there with her brother, Baron Eugen DeCobray, a humanitarian on a mission to check on a shipment of medical supplies. The two arrive at the warehouse where the supplies were meant to have been delivered, only to find it empty. Two Vietnamese men enter — the same two who attacked <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. Eugen asks the Baroness to wait in the office while he speaks with them. It is the last time she ever sees him alive.
          </p>
          <p>
