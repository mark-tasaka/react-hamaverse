    ...
    <main className="issue-profile-page">
      <div className="container">
        ...
        <section className="issue-section">
          ...
          <p>
            In the Pit, Hawk recounts his second encounter with <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. He and Stalker were putting together the G.I. Joe team, and Stalker recommended <Link to="/character-bios/SnakeEyes">Snake Eyes</Link>. They tracked him to a cabin in the High Sierras, where they found a wolf living alongside him and <Link to="/character-bios/SnakeEyes">Snake Eyes</Link> himself carrying dead rabbits he'd caught with his bare hands. Hawk and Stalker convinced him to join G.I. Joe.
          </p>
          <p>
